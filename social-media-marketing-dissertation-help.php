...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `social-media-marketing-dissertation-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `social-media-marketing-dissertation-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `social-media-marketing-dissertation-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `social-media-marketing-dissertation-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `social-media-marketing-dissertation-help-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'social-media-marketing-dissertation-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `social-media-marketing-dissertation-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can You Fix the Formatting of My Social Media Marketing Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Ensuring proper formatting for your dissertation is crucial. If your dissertation is written but lacks the correct format, there's no need to worry. Our skilled editors can swiftly reformat your dissertation to meet your specific requirements."
    }
  },{
    "@type": "Question",
    "name": "Can You Assist Me in Generating Engaging Topics for My Social Media Marketing Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Our team of experts in Social Media Marketing can create captivating dissertation topics for you whenever you need. You can provide your own topics for refinement or guide our professionals in developing personalized topics that align with your preferences."
    }
  },{
    "@type": "Question",
    "name": "How Many Words Should Be in an MBA Dissertation on Social Media Marketing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Usually, MBA dissertations about Social Media Marketing can range from 15,000 to 50,000 words, depending on the specific topic and research needs. The precise word count is typically determined by your supervisor or professor's guidelines."
    }
  },{
    "@type": "Question",
    "name": "Can I Order Using My Phone for Social Media Marketing Dissertation Help?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Whether you're using your phone, laptop, or tablet, you can easily place an order. If you encounter any issues with the website's order form, you can also contact us via Phone Number, Live Chat, or Email for assistance."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Expert assistance for your social media marketing dissertation. Unlimited revisions, skilled writers, and 25% off on your first order. Contact us today!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Social Media Marketing Dissertation Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Assistance-for-Social-Media-Marketing-Dissertations-_1_.webp" alt="social-media-marketing-dissertation-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
...
<div class="container">
  <div class="row"> 
    ...
    <div class="content">
      ...
      <h3 onclick="toggleContent(this)"><?php echo $headingb6;?></h3>
         <div class="content">
      <p id="mbaallp"><?php echo $parab6;?></p>
       
      </div>
     <h3 onclick="toggleContent(this)"><?php echo $headingb7;?></h3>
         <div class="content">
...
<!--<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Optimal-Assistance-for-PhD-Data-Collection-Help.webp" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/social-media-marketing-dissertation-help-faq.php'?>
