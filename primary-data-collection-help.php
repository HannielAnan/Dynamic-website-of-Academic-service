...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `primary-data-collection-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `primary-data-collection-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `primary-data-collection-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `primary-data-collection-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `primary-data-collection-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'primary-data-collection-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `primary-data-collection-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is there a possibility of hidden fees?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We are committed to transparency. There are no additional costs or hidden charges. Our pricing structure is openly presented for your convenience."
    }
  },{
    "@type": "Question",
    "name": "How to Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Initiate your order by clicking on the 'Order Now' tab located at the screen's top. This will guide you to our user-friendly online order form, streamlining the process."
    }
  },{
    "@type": "Question",
    "name": "What is the Delivery Time for My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our delivery timeline corresponds to the time/days you specify for your dissertation submission. Experience on-time delivery tailored to your schedule."
    }
  },{
    "@type": "Question",
    "name": "What's the Duration for Dissertation Writing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The timeframe varies based on your dissertation's specifications. On average, crafting a dissertation may take one to two months. Our proficient experts can even meet tighter deadlines for your convenience."
    }
  },{
    "@type": "Question",
    "name": "Is Dissertation Topic the Same as the Title?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The dissertation topic you choose defines the core focus, guiding the entire content. Meanwhile, the title is derived from this chosen topic, highlighting its essence. The distinction between the two is crucial for a well-structured dissertation."
    }
  },{
    "@type": "Question",
    "name": "How to Generate an Excellent Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Begin by identifying your preferred domain and conducting initial research on a specific aspect within it. This process will unveil emerging challenges, issues, or gaps that can be seamlessly transformed into a compelling topic. Crafting an engaging and valuable dissertation topic has never been easier!"
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Enhance research quality with reliable primary data collection. Experts ensure accuracy, relevance. Contact us for top-notch services</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">How to Acquire a Primary Data Collection Assist.</h2>
      <p id="para3rd">Provide Your Order Details: Firstly, one should fill the order form in order to start the process of ordering dissertations. List down all your favorite specifications as well as any customization you would want. Make sure that you systematically specify each requirement and fill in all indicated spaces correctly.</p>
    </div>
  </div>
</div>
<div class="container">
...
<div class="row">
<div class="col-lg-12">
<img src="images/Expert-Guidance-for-Primary.webp" id="subpagebanner" class="img-fluid" alt="primary-data-collection-help">
</div>
</div>
</div>
...
<div class="container">
  <div class="row"> 
    ...
    <div class="content">
      ...
      <h3 onclick="toggleContent4(this)"><?php echo $headingb4;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/primary-data-collection-help.php'?>
