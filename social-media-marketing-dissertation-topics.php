...
$sql = "SELECT * FROM  `social-media-marketing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'social-media-marketing-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `social-media-marketing-dissertation-topic-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is Your Payment Process Secure?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our payment system is super safe. It's protected by the latest SSL security, so you can transfer your payment with confidence."
    }
  },{
    "@type": "Question",
    "name": "How to Write a Good Dissertation Discussion in Social Media Marketing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Writing the dissertation discussion is both exciting and tough. It involves explaining your results, addressing your research question, and critically evaluating your study"
    }
  },{
    "@type": "Question",
    "name": "What's the Ideal Word Count for a Ph.D. Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A Ph.D. dissertation should be around 80,000 words, including everything except the bibliography."
    }
  },{
    "@type": "Question",
    "name": "Why Should I Get a Social Media Marketing Dissertation Topic from You?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Getting a dissertation topic from us means a secure and confidential transaction. Plus, we offer many benefits when you order a topic. We're also open to custom topics, so don't hesitate to contact us."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/social-media-marketing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Social Media Marketing Dissertation Topics for the younger generation's favorite platforms Discover custom ideas, expert advice, and secure payment options</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Social Media Marketing Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/social-media-marketing-dissertation-topics-faq.php'?>
