...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `supply-chain-management-dissertation-editing-and-proof-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `supply-chain-management-dissertation-editing-and-pr-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `supply-chain-management-dissertation-editing-and-proof-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `supply-chain-management-dissertation-editing-and-p-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `supply-chain-management-dissertation-editing-and-proof-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'supply-chain-management-dissertation-editing-and-proofreading-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `supply-chain-management-dissertation-editi-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can I Check Where My Supply Chain Management Dissertation Proofreading Order Is?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You can keep an eye on your order through our customer support system. Just ask, and it will tell you where your order is in the process. You can track it from when we start working on it until we deliver it to you."
    }
  },{
    "@type": "Question",
    "name": "How Long Does SCM Dissertation Proofreading Take?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "At the very least, it will take 3 days. But if you really need it quickly, we can speed things up. Just ask for an urgent proofreading session from our certified proofreader for your supply chain management dissertation. The time it takes mostly depends on when you need it and what we agreed upon for the deadline with your SCM dissertation proofreading order."
    }
  },{
    "@type": "Question",
    "name": "Can You Edit a Supply Chain Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, we can expertly edit your supply chain management dissertation. We have a big team of supply chain professionals who have many years of experience in editing dissertations, and they are well-known for their expertise. It doesn't matter what level of education you're at; we'll always assign a PhD editor in supply chain management to your work."
    }
  },{
    "@type": "Question",
    "name": "Who Can Edit My Supply Chain Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "An expert in the field, someone who has worked in supply chain management for more than 5 years, can easily edit your supply chain management dissertation. They'll carefully go through each chapter and heading, making sure the sentences align with the main goal. We have a team of expert editors who not only have degrees in supply chain management but also excel at editing dissertations in this field."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Get top-quality editing and proofreading for your Supply Chain Management Dissertation. Our team ensures flawless and well-structured dissertations.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Supply Chain Management Dissertation Editing And Proofreading Service</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Looking-For-Help-To-Improve-Your-Supply-Chain-Management-dissertation.webp" alt="supply-chain-management-dissertation-editing-and-proofreading-service" title="supply-chain-management-dissertation-editing-and-proofreading-service" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row"> 
    ...
    <div class="content">
      ...
      <p id="mbaallp"><?php echo $parab4;?></p>
       ...
       <h3 onclick="toggleContent4(this)"><?php echo $headingb5;?></h3>
         <div class="content">
      <p id="mbaallp"><?php echo $parab5;?></p>
      </div>  
      <h3 onclick="toggleContent4(this)"><?php echo $headingb6;?></h3>
         <div class="content">
      <p id="mbaallp"><?php echo $parab6;?></p>
       
      </div>
     <h3 onclick="toggleContent4(this)"><?php echo $headingb7;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/supply-chain-management-dissertation-editing-and-proofreadin-faq.php'?>
