...
$sql = "SELECT * FROM  `phd-nursing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'phd-nursing-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `phd-nursing-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How can I order a Ph.D. nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Ordering a dissertation has never been easier. You can purchase a flawlessly written PhD, BSc, MSc, or any other dissertation at any time from DissertationWritingHelp. We have a large team of subject matter experts available 24/7 to meet all your dissertation needs. To place an order, simply fill out the order form on our website. If you encounter any issues, don't worry; you can contact us via live chat, email, or our contact number to have all your questions answered immediately.\""
    }
  },{
    "@type": "Question",
    "name": "How many parts are in a PhD nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A PhD dissertation usually has five parts, and they follow a specific order. First, there's the Introduction section, then the Literature Review part. After that, you'll find the Methodology section, followed by Data Collection and Analysis. Finally, there's the last part called Recommendations and Interpretations. If you encounter any difficulties in organizing your dissertation, feel free to contact us anytime you need help. DissertationWritingHelp is here to assist you whenever you face any challenges."
    }
  },{
    "@type": "Question",
    "name": "Is it possible to purchase individual chapters for my PhD nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, you can place a custom order anytime you'd like. If, for example, you're having difficulty with the Methodology chapter, you can contact us and purchase a well-written Methodology chapter. While it's recommended to have a single writer handle your entire dissertation, if you only need help with one or two chapters, you're welcome to place your order right away!"
    }
  },{
    "@type": "Question",
    "name": "Is it okay to hire someone to write my dissertation for me?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it's totally fine and legal to hire someone to write your dissertation. But you should be really careful when choosing the right person for the job. If you're unsure about who to hire for your dissertation, don't worry. DissertationWritingHelp provides top-notch dissertation writing services that can help you get excellent grades at affordable prices!"
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/phd-nursing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
   ...
   <p class="hidden">Valuable list of PhD nursing dissertation topics by experts in the field. Choose from a variety of topics in your dissertation work. Contact us now!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">PhD Nursing Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/phd-nursing-dissertation-topics-faq.php'?>
