...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-writing-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-writing-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-Writing-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-writing-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-writing-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-writing-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-writing-service-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our live chat support operates 7 days a week, 365 days a year. You can connect with our writers through email, live chat, and even WhatsApp!"
    }
  },{
    "@type": "Question",
    "name": "Why Should I Seek Dissertation Assistance from Your Service?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our team comprises Ph.D. writers from leading universities who are dedicated to helping you achieve top grades in your dissertations. When you require quick British dissertation help nearby, DissertationWritingHelp is always accessible."
    }
  },{
    "@type": "Question",
    "name": "What Sets Your Dissertation Services Apart as the Most Trustworthy?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our track record speaks for itself, as we have never disappointed a single student with our exceptional dissertation writing services. We deliver each student a high-quality, creatively crafted dissertation tailored to their specific requirements by subject matter experts. When someone approaches us with the statement, 'I need help writing my dissertation,' we never shy away. Our primary objective revolves around providing each student with the best dissertation assistance, making us the most dependable choice."
    }
  },{
    "@type": "Question",
    "name": "What If I'm Unsatisfied with the Services Offered by Your Dissertation Company?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Customer satisfaction is our foremost priority, and we offer a money-back guarantee if you are dissatisfied with our services."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
 <?php include 'googlebodycode.php'; ?>
    <p class="hidden">Access exceptional PHD dissertations online through our team of expert writers. Ensure academic success with professional assistance and top-notch quality.</p>
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
    <img src="images/Top-Quality-Dissertation-Writing-Help-banner.webp" alt="Top-Quality-Dissertation-Writing-Help" title="Top Quality Dissertation Writing Help" class="img-fluid">
    </div>
  </div>
</div>
   <div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Say goodbye to your academic worries with our Dissertation Writing Help Services.</h2>
    </div>
  </div>
</div>
<!--<div class="container">
...
<!--<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/TABLE.png" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-writing-help-faq.php'?>
