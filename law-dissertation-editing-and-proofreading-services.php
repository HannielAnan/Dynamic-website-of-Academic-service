...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `law-dissertation-editing-and-proofreading-services-black-box`";
...
<!--<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Dissertation-Viva-Counselling-Expert-Guidance-for-Successful-Presentation.webp" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
