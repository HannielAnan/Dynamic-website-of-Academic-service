...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-poster-writing-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-writing-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-writing-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-writing-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-poster-writing-services-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-poster-writing-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-poster-writing-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How Long Does It Take to Write a Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The time needed to write a dissertation can vary. Usually, it takes around a month or two, but our experts can also finish it quickly if there's a tight deadline."
    }
  },{
    "@type": "Question",
    "name": "How Do You Collect Data for the Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We use three ways to collect data, depending on what your dissertation is about. These are quantitative (numbers-based), qualitative (words-based), and a mix of both methods."
    }
  },{
    "@type": "Question",
    "name": "Do You Use SPSS for Analyzing Data?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, we use SPSS to analyze data. But sometimes, we use other software too, depending on what your dissertation needs and what you want."
    }
  },{
    "@type": "Question",
    "name": "Are There Any Secret Costs?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Nope, not at all! We don't ask for extra money unexpectedly. All our prices and charges are openly shared."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Explore our top-notch Dissertation Poster Writing Services for quantitative, qualitative, and mixed method research. Get affordable help. Contact us now!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Poster Writing Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Explore-our-Dissertation-Poster-Writing-Services-for.webp" id="subpagebanner" alt="dissertation-poster-writing-services" class="img-fluid">
        </div>
    </div>
</div>
...
<!--<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Explore-our-Dissertation-Poster-Writing-Services-for.webp" alt="dissertation-poster-writing-services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-poster-writing-services-faq.php'?>
