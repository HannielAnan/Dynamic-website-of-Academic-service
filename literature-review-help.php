...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `literature-review-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `literature-review-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `literature-review-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `literature-review-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `literature-review-help-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'literature-review-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `literature-review-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Will you be able to create my marketing Literature Review?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We can craft a literature review for you, regardless of the domain, topic, or title you opt for, all tailored to your dissertation."
    }
  },{
    "@type": "Question",
    "name": "Who will write my literature review?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The person in our team who's an expert in literature will be in charge of creating your literature review completely."
    }
  },{
    "@type": "Question",
    "name": "Is the literature review the longest chapter in a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, the literature review is typically the most detailed and longest chapter in a dissertation."
    }
  },{
    "@type": "Question",
    "name": "How quickly can you complete my literature review order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We can finish your literature review in just 3 days if that's when you need it. We'll ensure it's ready on time."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
  ...
  <p class="hidden">Top-notch literature review help by experts. Structured, in-depth reviews. Contact us at +44 7564 313 614 or info@dissertationwritinghelp.net to order</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Literature Review Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Top-Literature-Review-Assistance-Services.webp" alt="literature review help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/literature-review-help-faq.php'?>
