...
$sql = "SELECT * FROM  `medical-education-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'medical-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `medical-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer a wide range of payment options for your convenience, including PayPal, bank transfers, and Paynote. We also accept payments from all major debit and credit cards."
    }
  },{
    "@type": "Question",
    "name": "How many students have utilized your services?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "With over a decade of experience, DissertationWritingHelp has successfully served more than 1500 students through our website. Rest assured, your order is in capable hands."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/medical-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Medical education dissertation topics to enhance your career. Explore expert ideas, including Harvard's COVID-19 research impact. Get tailored assistance!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Medical Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/medical-education-dissertation-topics-faq.php'?>
