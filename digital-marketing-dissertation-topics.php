...
$sql = "SELECT * FROM  `digital-marketing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'digital-marketing-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `digital-marketing-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can I Place an Order Using the Live Chat?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You can initiate an order through our 24/7 live chat support. Just start a chat with one of our sales representatives, share your requirements, and once your order details are confirmed, proceed with the payment. We'll get started on your work right away!"
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "With over a decade of experience, we've built a strong reputation for delivering exceptional writing services. Our commitment is to provide your work well before your specified deadline. This dedication has made us one of the top academic writing services in the UK."
    }
  },{
    "@type": "Question",
    "name": "How Will You Approach My Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our process begins with identifying research gaps. Once we pinpoint these gaps, our writers brainstorm ideas to structure your dissertation effectively. After the planning phase, we proceed with the writing, adhering to your specific instructions and requirements."
    }
  },{
    "@type": "Question",
    "name": "What's the Acceptance Rate for Digital Marketing Dissertation Topics by Your Writers?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our writers at DissertationWritingHelp are highly skilled and dedicated. Thanks to their hard work and expertise, our dissertation topics have been accepted over 98% of the time. In rare cases of rejection, our unlimited revision service ensures your new topic will gain acceptance!"
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/digital-marketing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Discover Exciting Digital Marketing Dissertation Ideas for 2023! Plus More Topics. Get Customized Dissertation Topics Tailored Just for You! Order Now!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Digital Marketing Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/digital-marketing-dissertation-topics-faq.php'?>
