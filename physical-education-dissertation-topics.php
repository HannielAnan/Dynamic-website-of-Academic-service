...
$sql = "SELECT * FROM  `physical-education-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'physical-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `physical-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What Percentage of Your Dissertation Chapters Matter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Each of the five dissertation chapters contributes differently to your total word count. The introduction holds a 10% weight, the literature review carries 30%, methodology and data collection both account for 10%, and the conclusion is also 10%."
    }
  },{
    "@type": "Question",
    "name": "How Long Does Dissertation Writing Take?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The time required to complete a dissertation varies based on factors like topic complexity, degree level, and data needs. For a Ph.D. dissertation with a complex topic and extensive data, it may take up to 6 months."
    }
  },{
    "@type": "Question",
    "name": "Is Failing a Dissertation Possible?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it is possible to fail your dissertation. If you miss your submission deadline, you may get an extension. However, failing to complete your work in the additional time can result in various consequences, including direct failure, particularly if plagiarism is detected."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You have multiple options to place an order: click the \"Order Now\" button, use WhatsApp, email us your requirements, or access our live chat support. We're here to make it convenient for you."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/physical-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Struggling with your dissertation topic? You're not alone! DissertationWritingHelp offers top-notch physical education dissertation topics and ideas.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Physical Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/physical-education-dissertation-topics-faq.php'?>
