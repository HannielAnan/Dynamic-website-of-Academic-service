...
$sql = "SELECT * FROM  `ma-education-dissertation-topics-after-brown-box-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'ma-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `ma-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is the Purpose of Dissertation Writing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The primary objective of writing a dissertation is for educational institutions worldwide to graduate students equipped with comprehensive knowledge of their respective professional fields. As dissertations delve deep into specific research problems, they contribute significantly to the development of one's professional life. Furthermore, including your dissertation topic on your CV can serve as a testament to your skills and expertise."
    }
  },{
    "@type": "Question",
    "name": "Is Purchasing a Dissertation Topic Legal?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, availing dissertation writing services is entirely within the bounds of the law, with no legal violations. This is evidenced by the fact that over 1500 students have opted for our professional writing assistance."
    }
  },{
    "@type": "Question",
    "name": "How Will We Approach Your Dissertation Writing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We initiate the dissertation writing process by thoroughly reviewing your requirements. Subsequently, we formulate a well-structured plan of action, diligently adhering to your specifications to ensure exceptional outcomes."
    }
  },{
    "@type": "Question",
    "name": "How Can You Place an Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Placing an order on our website is a straightforward process. You can do so by simply clicking the \"Order Now\" button. Alternatively, you can reach out to us via email, live chat support, phone call, or WhatsApp for seamless order placement."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/ma-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Struggling to find an MA Education Dissertation Topic? Explore effective research ideas with us, including an exceptional MA Education Dissertation Idea.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">MA Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/ma-education-dissertation-topics-faq.php'?>
