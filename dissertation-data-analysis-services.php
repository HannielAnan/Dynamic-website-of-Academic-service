...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-data-analysis-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-data-analysis-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-data-analysis-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-data-analysis-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-data-analysis-services-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-data-analysis-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-data-analysis-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Are there concealed fees?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We refrain from imposing any additional costs. Our pricing structure is completely transparent and openly presented."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To commence your order, simply click on the 'Order Now' tab located at the screen's top. This action will guide you to our online order form."
    }
  },{
    "@type": "Question",
    "name": "What is the estimated delivery time for my dissertation order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time aligns with the timeframe you specify for your dissertation submission"
    }
  },{
    "@type": "Question",
    "name": "What is the time frame for completing a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration varies according to the dissertation's specifications. Generally, it takes around one to two months to write a dissertation; however, our experts are capable of meeting tighter deadlines if necessary."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Enhance research with Dissertation Data Analysis. Experts analyze quantitative, qualitative, and mixed-method data for credible insights tailored to you.</p>
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Exceptional-Dissertation-DataAnalysis-Service-_1_.webp" alt="dissertation-data-analysis-services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-data-analysis-service-faq.php'?>
