...
$sql = "SELECT * FROM  `event-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'event-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `event-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is It Legal to Purchase Event Management Dissertations Online?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly, it is both ethical and legal to buy an event management dissertation online. Writing a dissertation can be a lengthy and challenging process, and seeking assistance online is similar to getting tutoring or guidance to help you complete this demanding task effectively.
Certainly, it is both ethical and legal to buy an event management dissertation online. Writing a dissertation can be a lengthy and challenging process, and seeking assistance online is similar to getting tutoring or guidance to help you complete this demanding task effectively."
    }
  },{
    "@type": "Question",
    "name": "What Is the Weight of Each Dissertation Chapter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The weight of each chapter in a dissertation varies based on word count and the specific requirements of your dissertation. Generally, chapters are distributed as follows: Introduction: 15% Literature Review: 30% Methodology: 10% Data Collection and Analysis: 30% Interpretation and Recommendations: 15%"
    }
  },{
    "@type": "Question",
    "name": "Can a PhD Event Management Dissertation Be Rejected?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it is possible for a Ph.D. event management dissertation to be rejected if it does not meet the academic standards and guidelines set by your institution or committee. Common reasons for rejection include inadequate research design, insufficient data, a weak literature review, lack of originality, subpar analysis, or instances of plagiarism. It is essential to collaborate closely with your academic advisor or supervisor to ensure your research aligns with the required standards."
    }
  },{
    "@type": "Question",
    "name": "When Should I Place an Order for an Event Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can place an order for your dissertation at your convenience. However, it is advisable to do so at least a week before your deadline. This allows ample time to address any potential technical issues or delays in delivery. Additionally, having a buffer period ensures you can make any necessary revisions or adjustments to your dissertation, which can be a time-consuming process. To be on the safe side, consider placing your order as early as possible."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/event-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
        ...
        .custom-container::before {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(0, 0, 0, 0.7); /* Replace with your desired background color and opacity */
        }
...
<body>
    ...
    <p class="hidden">Event management dissertation topics recommended by experts. Get ideas and the latest research topics for 2023. Find answers to your FAQs. Order now!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Event Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/event-management-dissertation-topics-faq.php'?>
