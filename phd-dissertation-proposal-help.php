...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `phd-dissertation-proposal-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-proposal-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-proposal-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-proposal-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `phd-dissertation-proposal-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'phd-dissertation-proposal-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `phd-dissertation-proposal-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Could you complete my dissertation proposal within a month?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Share your specifications, and our Ph.D. experts will expedite the process, delivering your custom dissertation proposal ahead of schedule."
    }
  },{
    "@type": "Question",
    "name": "Is crafting a dissertation proposal more time-consuming than the entire dissertation itself?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly not! While it requires less time than the complete dissertation, it still necessitates sufficient time to encompass all crucial elements of a comprehensive proposal."
    }
  },{
    "@type": "Question",
    "name": "What is the typical length of a Ph.D. dissertation proposal?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The majority of proposals span around 10 pages. However, the length can extend to 15-20 pages based on the scope of your research."
    }
  },{
    "@type": "Question",
    "name": "How do I request dissertation proposal help from your service?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can initiate an order by clicking the \"order now\" button or by reaching out to us via email or phone."
    }
  },{
    "@type": "Question",
    "name": "How secure is your transaction process?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our payments are protected by the latest version of SSL security certificates. We make sure our students don’t face any problems when they are paying for their order."
    }
  },{
    "@type": "Question",
    "name": "What is your payment criteria?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our payment criteria are 100% upfront. In very rare cases do we allow 50% payment upfront and 50% after the work is completed."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Ph.D. proposal help? Contact us at +44 7564 313 614. Expert writers, flawless content, 25% off 1st order!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Buy PhD Dissertation Proposal Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/PhD-Dissertation-Proposal-Help-Is-Available-At-This-Very-Place.webp" alt="phd-dissertation-proposal-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/phd-dissertation-proposal-help-faq.php'?>
