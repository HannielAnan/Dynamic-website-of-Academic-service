...
$sql = "SELECT * FROM  `child-nursing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'child-nursing-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `child-nursing-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How much should I budget for a child nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The cost of a dissertation can vary depending on several factors. One of the most significant factors is your academic level. The length of the dissertation varies at each level of education. For example, a BBA dissertation is typically shorter than an MBA dissertation, while a Ph.D. dissertation is usually the longest. The price may also vary depending on the complexity of your topic and the required length of the dissertation."
    }
  },{
    "@type": "Question",
    "name": "Can you do my MSc child nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, that's exactly what we do! We have a team of skilled writers who can take care of all your dissertation requirements quickly. Whether you need a dissertation written from the beginning or if you want someone to check and correct your dissertation, we can handle it. It doesn't matter if you're a Ph.D. student or studying for a BBA; we're here to assist you whenever you need it!"
    }
  },{
    "@type": "Question",
    "name": "Can copying ideas make my child's nursing dissertation not accepted?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, definitely! Plagiarism is something nobody wants to find in a dissertation. Your dissertation must be entirely unique and genuine. Whenever you use information from other sources, you need to give them credit by citing them correctly to avoid any plagiarism issues. If you're having trouble making an original dissertation, you can reach out to us. Our services are available 24/7, all year round. We have a team of experts in the field who can write excellent dissertations for you."
    }
  },{
    "@type": "Question",
    "name": "Is my information safe when I buy a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Your privacy is very important to us. We use strong computer programs to keep all your information safe and protected. You can purchase a dissertation without any worries because we make sure your data is secure."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/child-nursing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore a valuable list of child nursing dissertation topics by professionals. Choose from engaging topics for dissertation work. Contact us now!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Child Nursing Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <?php include 'includes/pricing.php'?>
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/child-nursing-dissertation-topics-faq.php'?>
