...
$sql = "SELECT * FROM  `Graphic Design Dissertation Topics and Ideas-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'graphic-design-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `graphic-design-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is the minimum order size allowed on your website?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The smallest order we can accept consists of just one page. Orders for less than this do not meet our criteria. However, the pricing for a one-page task varies depending on your specific requirements."
    }
  },{
    "@type": "Question",
    "name": "How can I craft an excellent graphic design dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To create an outstanding graphic design dissertation, treat it as a work of art. Instead of adorning your research with designs, focus on making your written content exceptional. Employ scholarly language and write passionately about your subject, as these are critical elements for achieving dissertation excellence."
    }
  },{
    "@type": "Question",
    "name": "What principles should guide me in selecting a graphic design dissertation topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Selecting a graphic design dissertation topic involves identifying a relevant problem within your field of research. Once you've identified the issue, create a thematic framework for your dissertation. These steps will serve as the foundation for guiding your dissertation writing process."
    }
  },{
    "@type": "Question",
    "name": "What does graphic design entail?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Graphic design is a discipline that centers around problem-solving through visual elements, iconography, and typography. Essentially, graphic design utilizes visuals and design principles to assist users of various mediums, such as customers, web users, and app users, in navigating and comprehending their interfaces."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/graphic-design-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Graphic design dissertation ideas to boost creativity. Our experts offer a curated list of topics for graphic design dissertations Get tailored topics now!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Graphic Design Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/graphic-design-dissertation-topics-faq.php'?>
