...
$sql = "SELECT * FROM  `masters-education-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'masters-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `masters-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is it possible to omit a section of my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Skipping a dissertation chapter can result in significant consequences. Your instructor is likely to notice the omission, leading to deductions in your marks. In some instances, your paper may be returned for revision."
    }
  },{
    "@type": "Question",
    "name": "What should I do if I'm unable to meet my dissertation deadline?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Every dissertation comes with a specified deadline, often spanning six months. If, for any reason, you are unable to complete your dissertation within the set timeframe, you can consider requesting an extension. However, extended deadlines may potentially delay your graduation."
    }
  },{
    "@type": "Question",
    "name": "Can I request assistance for just one chapter of my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly, you can. We are committed to supporting students to the best of our abilities. Therefore, we are willing to help with even the smallest requests. However, please note that we have a minimum order requirement of at least one page."
    }
  },{
    "@type": "Question",
    "name": "Am I allowed to seek proofreading services for my Master's education dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, you can. Our team includes certified proofreaders and editors who are eager to provide feedback and assistance with your work."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/masters-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Master Education Dissertation Topics crafted by expert writers to excel academically. Say goodbye to worries with DissertationWritingHelp!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Masters Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/masters-education-dissertation-topics-faq.php'?>
