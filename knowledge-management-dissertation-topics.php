...
$sql = "SELECT * FROM  `knowledge-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'knowledge-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `knowledge-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long does it typically take to complete a Knowledge Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The duration required to complete a dissertation varies based on several factors. Factors such as the dissertation's word count, academic level, and the nature of the research significantly influence the time needed. Generally, it's safe to assume that a PhD dissertation will take more time to complete compared to a BBA dissertation. If you have a tight deadline for your dissertation, feel free to reach out to us, and we can expedite the process, delivering your dissertation in just a few days."
    }
  },{
    "@type": "Question",
    "name": "What is the recommended citation style for a Knowledge Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We recommend adhering to the citation style advised by your supervisor or professor. If you're uncertain about the preferred citation style, it's best to consult your professor or supervisor for guidance. However, if you have the freedom to choose, commonly used citation styles like MLA, APA, Harvard, Chicago, and Turabian are safe choices."
    }
  },{
    "@type": "Question",
    "name": "How does my choice of dissertation topic impact my resume?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "It's worth noting that your dissertation topic is listed on your resume. Consequently, potential employers may review your dissertation topic as they assess your qualifications. Therefore, selecting an engaging and relevant dissertation topic can leave a positive first impression and potentially enhance your resume's appeal."
    }
  },{
    "@type": "Question",
    "name": "Can I request proofreading services for my Knowledge Management dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! We offer a wide range of academic services to assist students in various ways. Whether you need us to create your dissertation from scratch or require proofreading services, we're here to support you 24/7. You can easily reach out to us through our website's live chat feature or via email for assistance with your dissertation at any time."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/knowledge-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Engaging Knowledge Management dissertation topics and ideas to ease your stress. Our expert writers share valuable insights. Contact us for assistance!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Knowledge Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/knowledge-management-dissertation-topics-faq.php'?>
