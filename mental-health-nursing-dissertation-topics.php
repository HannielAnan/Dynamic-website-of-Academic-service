...
$sql = "SELECT * FROM  `mental-health-nursing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'mental-health-nursing-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `mental-health-nursing-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can you assist in crafting a Ph.D. dissertation in mental health nursing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! We specialize in crafting top-notch mental health nursing dissertations, catering to various academic levels, be it an MSc, Ph.D., or even an MPhil dissertation. Feel free to get in touch with us, and we'll assist you in completing and submitting your dissertation at a competitive price!"
    }
  },{
    "@type": "Question",
    "name": "How can I purchase a mental health nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Purchasing a mental health nursing dissertation is now more convenient than ever. You can contact us and have your dissertation expertly crafted by professionals quickly. It doesn't matter if you're an MBA student or an MPhil student; our team of dissertation experts can write an exceptional dissertation to help you achieve your desired academic goals"
    }
  },{
    "@type": "Question",
    "name": "How long does it take to write a Ph.D. mental health nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Writing a Ph.D. mental health nursing dissertation can vary in duration based on several factors. Unlike a Master's dissertation, which typically ranges from 12,000 to 20,000 words, a Ph.D. dissertation can be much longer, potentially reaching up to 80,000 words or more. The time it takes to complete a Ph.D. dissertation depends on various elements."
    }
  },{
    "@type": "Question",
    "name": "What is the significance of word count distribution in a mental health nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "In a mental health nursing dissertation, the distribution of word count among chapters is essential to maintain a well-balanced and structured document. Each chapter plays a specific role in shaping your research, and it's crucial to allocate the right weight (word count) to them for coherence and clarity."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/mental-health-nursing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
  ...
  <p class="hidden">Range of compelling mental health nursing dissertation topics to spark your interest. Explore these ideas and get started on your dissertation journey!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Mental Health Nursing Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/mental-health-nursing-dissertation-topics-faq.php'?>
