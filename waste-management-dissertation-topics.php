...
$sql = "SELECT * FROM  `waste-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'waste-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `waste-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can I modify the topics in the list of Waste Management dissertation topics above?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You have the freedom to adjust the topics to align with your interests and specific requirements. However, it's advisable to modify every topic found online to avoid potential issues with plagiarism detection. While the topics on this page are entirely original, plagiarism detection software may flag them as copied from this source, potentially affecting your dissertation's credibility."
    }
  },{
    "@type": "Question",
    "name": "What should I avoid to prevent dissertation rejection?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The most common reasons for dissertation rejection include plagiarism, grammatical and spelling errors, and late submissions. It's crucial to avoid these pitfalls at all costs. Although you can resubmit a rejected dissertation, it may not leave a favorable impression on the evaluation committee. The generally accepted threshold for plagiarism is 15%, but striving for minimal plagiarism is advisable."
    }
  },{
    "@type": "Question",
    "name": "How can I choose the best Waste Management dissertation topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The definition of the \"best\" topic can vary between students and professors. To select an excellent topic for your dissertation, avoid opting for one that is too common or extensively explored. Aim for a topic that is relatively unexplored but still offers sufficient research materials to support your dissertation. If you need assistance in choosing dissertation topics, feel free to contact us through the live chat, where our professional consultants are available to help you."
    }
  },{
    "@type": "Question",
    "name": "Do you maintain the confidentiality of your customers' data?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We prioritize the anonymity of our customers. Only the necessary information required to complete your dissertation is shared with the dissertation team, while all other personal information is securely stored using high-grade encryption software programs."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/waste-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Exploring captivating Waste Management dissertation topics has never been easier. Explore our list of intriguing ideas and topics to ace your dissertation.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Waste Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <!--?php include 'includes/pricing.php'?>
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/waste-management-dissertation-topics-faq.php'?>
