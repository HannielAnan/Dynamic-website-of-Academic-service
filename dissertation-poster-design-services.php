...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-poster-design-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-design-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-design-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-poster-design-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-poster-design-services-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-poster-design-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-poster-design-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How to Choose a Great Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Pick an area you're interested in and explore a specific aspect. This initial research will reveal emerging problems, gaps, or issues that can become your topic. This approach ensures a good and engaging dissertation topic."
    }
  },{
    "@type": "Question",
    "name": "How Do I Make an Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To place your order, click on the \"order now\" tab located at the top of the page. This will guide you to our online order form where you can provide your details."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We believe in transparent pricing. All our costs and fees are openly shared, and we don't have any hidden charges."
    }
  },{
    "@type": "Question",
    "name": "How Long Will It Take to Get My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time for your dissertation order depends on the timeframe you provide for its submission."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
   ...
   <p class="hidden">Get top-notch dissertation poster designs and accurate data presentation. Enjoy 25% OFF on your 1st order. Contact us at info@dissertationwritinghelp.net.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Poster Design Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Dissertation-Poster-Services-Professional-Designs-for-Research.webp" id="subpagebanner"  alt="Dissertation-Poster-Services-Professional-Designs-for-Research" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-poster-design-services-faq.php'?>
