...
$sql = "SELECT * FROM  `higher-education-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'higher-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `higher-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How do I select a suitable dissertation topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A strong dissertation topic aligns with your instructor's guidelines while also igniting your personal passion and interest."
    }
  },{
    "@type": "Question",
    "name": "Is it legal to purchase dissertation services?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, it is entirely legal. Numerous students, over 1500 of them, have benefited from our services. You can also achieve excellent grades effortlessly by simply placing an order on our website."
    }
  },{
    "@type": "Question",
    "name": "What are the main sections of a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A legitimate dissertation typically consists of five key sections: Introduction, Literature Review, Methodology, Findings, and Conclusion. Each of these segments plays a crucial role in enhancing the authenticity of your research."
    }
  },{
    "@type": "Question",
    "name": "Can I request assistance with a single chapter of my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly, you can. Our objective is to provide comprehensive support to students. Consequently, we are open to assisting with various academic tasks."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/higher-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Higher education dissertation topics to kickstart your research journey. DissertationWritingHelp offers dissertation ideas and a list of topics.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Higher Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/higher-education-dissertation-topics-faq.php'?>
