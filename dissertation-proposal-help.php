...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-proposal-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-proposal-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-proposal-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-proposal-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-proposal-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-proposal-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-proposal-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is it lawful to hire someone for my dissertation proposal writing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, it's legal. Engaging our top writers for expert help in crafting your proposal is well within legal boundaries. Our commitment is to maintain originality and deliver excellence."
    }
  },{
    "@type": "Question",
    "name": "Are hidden fees involved?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Definitely not. Our prices are transparent and market-competitive. You'll only pay the amount displayed during order placement."
    }
  },{
    "@type": "Question",
    "name": "Which payment options do you support?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We accept major credit/debit cards, bank transfers, PayPal, and Paynotes."
    }
  },{
    "@type": "Question",
    "name": "What's the core aim of a dissertation proposal?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The primary goal is gaining approval for your research concept. It's a concise preview of your dissertation's objectives and ideas, showcasing what you intend to explore in your research journey."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Expert help for your dissertation proposal. Tailored by skilled writers. Certified editors refine. 25% off 1st order. info@dissertationwritinghelp.net.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Buy Dissertation Proposal Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Acquire-Immediate-Dissertation-Proposal-Help.webp" alt="dissertation-proposal-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
...
<div class="container">
  <div class="row"> 
    ...
    <div class="content">
      ...
      <h3 onclick="toggleContent(this)"><?php echo $headingb4;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-proposal-help-faq.php'?>
