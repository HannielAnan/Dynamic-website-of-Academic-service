...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `write-my-dissertation-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `write-my-dissertation-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `write-my-dissertation-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `write-my-dissertation-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `write-my-dissertation-services-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'write-my-dissertation-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `write-my-dissertation-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is the most frequently utilized referencing style?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Various referencing styles exist, each employing distinct citation formats such as MLA, APA, and Chicago Style, among others. Among these, the most widely adopted styles for referencing in dissertations are MLA and APA."
    }
  },{
    "@type": "Question",
    "name": "How to structure a 10,000-word dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Effectively structuring a 10,000-word dissertation involves careful planning. You should engage in topic brainstorming, thorough research, create a preliminary outline, gather relevant data, conduct analysis, draft the content, go through the editing and proofreading stages, and remain receptive to feedback."
    }
  },{
    "@type": "Question",
    "name": "What is the optimal font choice for a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Globally, the widely recommended font for dissertations is Times New Roman. Other suitable options include Georgia, Garamond, Arial, and Cambria."
    }
  },{
    "@type": "Question",
    "name": "Who will be responsible for writing my dissertation if I choose your service?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Your dissertation will be crafted by skilled PhD/Master writers who possess a deep understanding of your field. We have writers covering a wide array of disciplines, ensuring the production of a high-quality dissertation tailored to your specifications"
    }
  },{
    "@type": "Question",
    "name": "Do you possess writers with Doctorate degrees to complete my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! We boast a team of over 100 in-house writers who are holders of PhD degrees in various subjects. This means whether you're a Law student or studying Nursing, we have an optimal solution for your needs."
    }
  },{
    "@type": "Question",
    "name": "Is it possible to make installment payments for my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly, you have the option to pay for your dissertation in installments. You can make an initial payment of 50% when placing your order, and the remaining amount can be settled upon receiving your first draft"
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Discover academic excellence with Write-My-Dissertation services. Rely on experts for on-time completion and achieve success with our support.</p>
  ...
  <i class="fa-solid fa-check" id="allcheckicon"></i> <?php echo $freeTopics[2] ?? ''; ?>
        ...
        <div class="d-flex align-items-center justify-content-center" id="formdiv">
              <form class="form" method="POST" id="formentry">
                ...
                <div class="row mb-3">
                    <input type="hidden" method="POST" class="form-control" name="page" value="write-my-dissertation-services">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Easy Process To Buy Our Write My Dissertation Service </h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="row">
<div class="col-lg-12">
<img src="images/write-my-dissertation.webp" id="subpagebanner" class="img-fluid" alt="write my dissertation services">
</div>
</div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/write-my-dissertation-services-faq.php'?>
