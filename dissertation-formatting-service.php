...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-formatting-service-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-formatting-service-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-formatting-service-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-formatting-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-formatting-service-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-formatting-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-formatting-service-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can You Help with My Statistics Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Of course! We're here to assist you with your statistics dissertation. Our skilled statistician will be assigned to create an excellent dissertation for you."
    }
  },{
    "@type": "Question",
    "name": "Can Bad Formatting Make You Fail Your Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it's possible. If your dissertation has poor formatting, you might have to submit it again on a different date. Incorrect formatting is one of the reasons for having to resubmit your dissertation."
    }
  },{
    "@type": "Question",
    "name": "Why Does Dissertation Formatting Matter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Formatting is really important in a dissertation. It's a crucial part of how your dissertation looks and is organized. Your school will tell you how to format your dissertation based on their rules."
    }
  },{
    "@type": "Question",
    "name": "Do You Have Experts for Marketing Dissertations?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We have experts who specialize in different subjects, including marketing. Our team includes specialists who work under the guidance of top dissertation professionals. Our marketing dissertation experts ensure to provide you with the best quality work."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
   ...
   <p class="hidden">Explore our top-notch Dissertation Formatting Help for quantitative, qualitative, and mixed method research. Get affordable help. Contact us now!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Formatting Service</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Get-the-Best-Dissertation-Formatting-Help.webp" alt="Get the best dissertation formatting help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
<!---<div class="container">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-formatting-service-faq.php'?>
