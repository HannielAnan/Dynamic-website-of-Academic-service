...
$sql = "SELECT * FROM  `quality-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'quality-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `quality-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How many chapters are typically in a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Usually, a dissertation comprises 5 chapters, though exceptions exist. If you haven't received specific guidelines, it's advisable to structure your dissertation with these 5 chapters. The first chapter is the Introduction, followed by the Literature Review, Methodology, Data Collection and Analysis, and finally, the Interpretations + Recommendations chapter."
    }
  },{
    "@type": "Question",
    "name": "What's the key to writing an engaging introduction chapter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "There are numerous ways to make your introduction chapter engaging, and our experts excel at it. To captivate your reader, your introduction should clearly convey the aims and objectives of your dissertation. Avoid making it overly dramatic, as it might confuse your reader."
    }
  },{
    "@type": "Question",
    "name": "What's the best citation style for a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Various universities have their preferred dissertation citation styles. If you're unsure about the guidelines, it's safe to use globally recognized citation styles like MLA, APA, Harvard, Chicago, and Turabian, among others. If you need assistance with your dissertation, feel free to contact us via our website's live chat feature. Our consultants are always available to help."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it is legal to buy a dissertation online. Purchasing a dissertation is akin to seeking help from academic journals, online articles, or professors. Why endure the stress of writing a dissertation when you can hire someone to do it for you? If you have more questions or need assistance, you can reach out to us through any of the provided contact methods."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/quality-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Quality Management dissertation topics? Explore a list of top topics with ideas and recommendations. Get the best grades with our expert guidance!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Quality Management Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/quality-management-dissertation-topics-faq.php'?>
