...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-viva-counselling-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-viva-counselling-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-viva-counselling-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-viva-counselling-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-viva-counselling-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-viva-counselling';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-viva-counselling-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What steps should I take to get ready for my dissertation viva?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The ultimate challenge in completing a dissertation is the viva voce examination. Your degree hinges on successfully navigating your dissertation viva. Yet, ensuring you're well-prepared for this critical oral examination requires adherence to three essential guidelines: A comprehensive review of your dissertation, Seeking guidance from a dissertation viva advisor, Cultivating self-assurance. To excel in your dissertation viva, simply embrace these three strategies, and position yourself for a victorious performance."
    }
  },{
    "@type": "Question",
    "name": "What kinds of inquiries are posed during a dissertation viva?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The queries revolve around the credibility of your dissertation and encompass various aspects. These encompass summarizing your dissertation, elucidating the rationale behind your chosen study domain or topic, detailing how your title was formulated, affirming the authenticity of your research questions, explaining the rationale for selecting specific research methods, elaborating on the study's outcomes, discussing its limitations, summarizing conclusions, delving into data analysis, and presenting the results of your dissertation"
    }
  },{
    "@type": "Question",
    "name": "What is the typical duration of a dissertation viva?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The length varies, typically ranging from 1 to 4 hours. The duration of the viva can be adjusted by the examiners at their discretion. In the case of PhD dissertation vivas, it's common for them to extend to 4 hours or even more."
    }
  },{
    "@type": "Question",
    "name": "Is it possible to not succeed in a viva?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly, if one is not adequately prepared. Failing a dissertation viva is a potential outcome for anyone who hasn't sufficiently readied themselves. It's undoubtedly a challenging endeavor. To face the viva, either thorough memorization of your dissertation is necessary or acquiring swift assistance from a dissertation viva advisor from our services. The viva is a significant undertaking that demands serious attention. Rather than risking failure, aim to excel with the guidance of experts."
    }
  },{
    "@type": "Question",
    "name": "How do I go about placing my order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To initiate your order, simply click on the 'order now' option located at the upper section of the screen. This action will guide you to our online order form. Complete the form by detailing your specific preferences and requirements for your research methodology. Allow our team of experts to provide you with the necessary assistance based on your inputs."
    }
  },{
    "@type": "Question",
    "name": "How reliable is your transaction procedure?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We ensure the security of our transactions through the most up-to-date SSL security certificates. Our priority is to ensure a seamless payment experience for our students, eliminating any concerns during the payment process."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Prepare confidently for your dissertation viva with expert counseling. Our guidance ensures you present your research effectively. Excel in your viva.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Buy Dissertation Viva Counselling</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Dissertation-Viva-Counselling-Expert-Guidance-for-Successful-Presentation.webp" alt="dissertation-viva-counselling" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row"> 
    ...
    <div class="content">
     ...
     <h3 onclick="toggleContent4(this)"><span class="toggle-icon">+</span> <?php echo $headingb7;?></h3>
      ...
      <h3 onclick="toggleContent4(this)"><span class="toggle-icon">+</span> <?php echo $headingb8;?></h3>
         <div class="content">
      <p id="mbaallp"><?php echo $parab8;?></p>
      </div>
           <h3 onclick="toggleContent4(this)"><span class="toggle-icon">+</span> <?php echo $headingb9;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-viva-counselling-faq.php'?>
