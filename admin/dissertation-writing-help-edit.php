...
$sql11 = "SELECT id, `heading`, `point1`, `point2`, `point3` FROM `dissertation-writing-help-black-box`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit11'])) {
    ...
    $stmt11 = $conn->prepare("UPDATE `dissertation-writing-help-black-box` SET `heading` = ?, `point1` = ?, `point2` = ?, `point3` = ? WHERE `id` = ?");
...
$sql12 = "SELECT id, `3boxes` AS `boxes`, `para` FROM `dissertation-writing-help-3brown-boxes`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit12'])) {
    ...
    // Prepare and bind the update statement
    $stmt12 = $conn->prepare("UPDATE `dissertation-writing-help-3brown-boxes` SET `3boxes` = ?, `para` = ? WHERE `id` = ?");
...
$sql13 = "SELECT id, `heading`, `para` FROM `dissertation-Writing-help-2headings`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit13'])) {
    ...
    // Prepare and bind the update statement
    $stmt13 = $conn->prepare("UPDATE `dissertation-Writing-help-2headings` SET `heading` = ?, `para` = ? WHERE `id` = ?");
...
$sql15 = "SELECT id, `heading1`, `heading2`, `heading3`, `heading4`, `heading5`, `heading6`, `para1`, `para2`, `para3`, `para4`, `para5`, `para6` FROM `dissertation-writing-help-after-brown-box3`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit15'])) {
    ...
    // Prepare and bind the update statement
    $stmt15 = $conn->prepare("UPDATE `dissertation-writing-help-after-brown-box3` SET `heading1` = ?, `heading2` = ?, `heading3` = ?, `heading4` = ?, `heading5` = ?, `heading6` = ?, `para1` = ?, `para2` = ?, `para3` = ?, `para4` = ?, `para5` = ?, `para6` = ? WHERE `id` = ?");
