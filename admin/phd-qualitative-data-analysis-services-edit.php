...
$seoOutput = display_and_update_records($conn, "phd-qualitative-data-analysis-services-title_and-description");
...
$sql11 = "SELECT id, `heading`, `point1`, `point2`, `point3` FROM `phd-qualitative-data-analysis-services-black-box`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit11'])) {
    ...
    $stmt11 = $conn->prepare("UPDATE `phd-qualitative-data-analysis-services-black-box` SET `heading` = ?, `point1` = ?, `point2` = ?, `point3` = ? WHERE `id` = ?");
    ...
    if ($stmt11->execute()) {
        ...
        header("Location: phd-qualitative-data-analysis-services-edit.php"); // Redirect to admin.php
        exit();
    } else {
...
$sql12 = "SELECT id, `3boxes` AS `boxes`, `para` FROM `phd-qualitative-data-analysis-services-3brown-boxes`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit12'])) {
    ...
    // Prepare and bind the update statement
    $stmt12 = $conn->prepare("UPDATE `phd-qualitative-data-analysis-services-3brown-boxes` SET `3boxes` = ?, `para` = ? WHERE `id` = ?");
...
$sql13 = "SELECT id, `heading`, `para` FROM `phd-qualitative-data-analysis-services-2headings`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit13'])) {
    ...
    // Prepare and bind the update statement
    $stmt13 = $conn->prepare("UPDATE `phd-qualitative-data-analysis-services-2headings` SET `heading` = ?, `para` = ? WHERE `id` = ?");
...
$sql14 = "SELECT id, `heading1`, `heading2`, `heading3`, `heading4`, `heading5`, `para1`, `para2`, `para3`, `para4`, `para5` FROM `dissertation-writing-service-big-brown-box`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit14'])) {
    ...
    // Prepare and bind the update statement
    $stmt14 = $conn->prepare("UPDATE `dissertation-writing-service-big-brown-box` SET `heading1` = ?, `heading2` = ?, `heading3` = ?, `heading4` = ?, `heading5` = ?, `para1` = ?, `para2` = ?, `para3` = ?, `para4` = ?, `para5` = ? WHERE `id` = ?");
...
$sql15 = "SELECT id, `heading1`, `heading2`, `heading3`, `heading4`, `heading5`, `heading6`, `para1`, `para2`, `para3`, `para4`, `para5`, `para6` FROM `phd-qualitative-data-analysis-services-after-brown-box3`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit15'])) {
    ...
    // Prepare and bind the update statement
    $stmt15 = $conn->prepare("UPDATE `phd-qualitative-data-analysis-services-after-brown-box3` SET `heading1` = ?, `heading2` = ?, `heading3` = ?, `heading4` = ?, `heading5` = ?, `heading6` = ?, `para1` = ?, `para2` = ?, `para3` = ?, `para4` = ?, `para5` = ?, `para6` = ? WHERE `id` = ?");
...
$sql16 = "SELECT id, `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`, `question7`, `answer7`, `question8`, `answer8` FROM `qualitative-data-dissertation-service-faq`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit16'])) {
    ...
    $stmt16 = $conn->prepare("UPDATE `qualitative-data-dissertation-service-faq` SET `heading`= ?, `question1`= ?, `answer1`= ?, `question2`= ?, `answer2`=?, `question3`=?, `answer3`=?, `question4`=?, `answer4`=?, `question5`=?, `answer5`=?,  `question6`=?, `answer6`=?, `question7`=?, `answer7`=?, `question8`=?, `answer8`=?  WHERE `id` = ?");
