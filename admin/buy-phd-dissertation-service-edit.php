...
function display_and_update_records($conn, $table) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: buy-phd-dissertation-services-edit.php" . $_SERVER['PHP_SELF']);
            exit;
        } else {
...
$seoOutput = display_and_update_records($conn, "buy-phd-dissertation-service-title_and-description");
//<!--Brown boxes end--!-->
//Black box 
// Assuming you have already established a connection to the database ($conn)

$sql22 = "SELECT id, `heading`, `point1`, `point2`, `point3` FROM `buy-phd-dissertation-services-black-box`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit22'])) {
    ...
    $stmt22 = $conn->prepare("UPDATE `buy-phd-dissertation-services-black-box` SET `heading` = ?, `point1` = ?, `point2` = ?, `point3` = ? WHERE `id` = ?");
    ...
    if ($stmt22->execute()) {
        ...
        header("Location: buy-phd-dissertation-services-edit.php"); // Redirect to admin.php
        exit();
    } else {
...
$sql21 = "SELECT id, `3boxes` AS `boxes`, `para` FROM `buy-phd-dissertation-service-3brown-boxes`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit21'])) {
    ...
    // Prepare and bind the update statement
    $stmt21 = $conn->prepare("UPDATE `buy-phd-dissertation-service-3brown-boxes` SET `3boxes` = ?, `para` = ? WHERE `id` = ?");
...
$sql20 = "SELECT id, `heading`, `para` FROM `buy-phd-dissertation-service-2headings`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit20'])) {
    ...
    // Prepare and bind the update statement
    $stmt20 = $conn->prepare("UPDATE `buy-phd-dissertation-service-2headings` SET `heading` = ?, `para` = ? WHERE `id` = ?");
...
$sql19 = "SELECT id, `heading1`, `heading2`, `heading3`, `heading4`, `heading5`, `para1`, `para2`, `para3`, `para4`, `para5` FROM `buy-phd-dissertation-service-big-brown-box`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit19'])) {
    ...
    // Prepare and bind the update statement
    $stmt19 = $conn->prepare("UPDATE `buy-phd-dissertation-service-big-brown-box` SET `heading1` = ?, `heading2` = ?, `heading3` = ?, `heading4` = ?, `heading5` = ?, `para1` = ?, `para2` = ?, `para3` = ?, `para4` = ?, `para5` = ? WHERE `id` = ?");
...
$sql18 = "SELECT id, `heading1`, `heading2`, `heading3`, `heading4`, `heading5`, `heading6`, `para1`, `para2`, `para3`, `para4`, `para5`, `para6` FROM `buy-phd-dissertation-service-after-brown-box3`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit18'])) {
    ...
    // Prepare and bind the update statement
    $stmt18 = $conn->prepare("UPDATE `buy-phd-dissertation-service-after-brown-box3` SET `heading1` = ?, `heading2` = ?, `heading3` = ?, `heading4` = ?, `heading5` = ?, `heading6` = ?, `para1` = ?, `para2` = ?, `para3` = ?, `para4` = ?, `para5` = ?, `para6` = ? WHERE `id` = ?");
...
//faq part
$sql17 = "SELECT id, `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`, `question7`, `answer7`, `question8`, `answer8`,`question9`, `answer9`  FROM `buy-phd-dissertation-service-faq`";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit17'])) {
    ...
    // Prepare and bind the update statement
    $stmt17 = $conn->prepare("UPDATE `buy-phd-dissertation-service-faq` SET `heading`= ?, `question1`= ?, `answer1`= ?, `question2`= ?, `answer2`=?, `question3`=?, `answer3`=?, `question4`=?, `answer4`=?, `question5`=?, `answer5`=?,  `question6`=?, `answer6`=?, `question7`=?, `answer7`=?, `question8`=?, `answer8`=?,`question9`=?, `answer9`=?   WHERE `id` = ?");
