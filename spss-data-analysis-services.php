...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `spss-data-analysis-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `spss-data-analysis-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `spss-data-analysis-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `spss-data-analysis-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `spss-data-analysis-services-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'spss-data-analysis-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `spss-data-analysis-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Are you utilizing SPSS for conducting data analysis?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Indeed, SPSS serves as a tool for data analysis, and the choice of other software is determined by the specific needs of the dissertation and the preferences of the client."
    }
  },{
    "@type": "Question",
    "name": "Are There Any Unseen Costs?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We steer clear of any additional charges. Our pricing and fees are completely transparent and openly displayed."
    }
  },{
    "@type": "Question",
    "name": "How Do I Initiate My Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To place an order, simply click on the 'order now' tab located at the top of the screen. This will guide you to our online order form."
    }
  },{
    "@type": "Question",
    "name": "What's the Estimated Delivery Time for My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Rest assured; the delivery time aligns with your desired submission timeline. We prioritize meeting your specified timeframe."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The timeline varies based on the dissertation's specifications. On average, crafting a dissertation takes around one to two months, though our adept experts can expedite the process for tighter deadlines."
    }
  },{
    "@type": "Question",
    "name": "Are Dissertation Topic and Title Identical?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "No, they're distinct. The dissertation topic, chosen from your field, shapes the entire study. Meanwhile, the dissertation title is derived from the topic and differs, encompassing its essence. They're separate elements."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Unlock insights with expert SPSS data analysis. Statisticians offer in-depth results for informed decision-making.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a SPSS Data Analysis services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Exceptional-SPSS-Data-Analysis-Services.webp" id="subpagebanner" class="img-fluid" alt="spss-data-analysis-services">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/spss-data-analysis-services-faq.php'?>
