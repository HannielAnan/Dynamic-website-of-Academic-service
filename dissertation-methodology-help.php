...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-methodology-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-methodology-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-methodology-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-methodology-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-methodology-help-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-methodology-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-methodology-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can you handle only my methodology order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We're here to assist with all sorts of dissertation orders, whether it's a complete dissertation or just a single chapter."
    }
  },{
    "@type": "Question",
    "name": "Could someone review my dissertation for errors?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! Our proofreading specialists in your dissertation field will be glad to review your work and identify any errors or mistakes, ensuring you avoid receiving lower grades."
    }
  },{
    "@type": "Question",
    "name": "Who will be in charge of editing my dissertation methodology?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our team of certified editors will be responsible for editing your dissertation methodology, ensuring it becomes error-free and flawless."
    }
  },{
    "@type": "Question",
    "name": "Is composing the methodology section simpler?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "While the methodology section of a dissertation might seem less complex than other chapters, it still demands techniques and expertise to create an exceptional methodology."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Get top-notch Dissertation Methodology Assistance for effective citing, analysis, and research. Achieve excellence in your methodology chapter!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Methodology Assistance</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/dissertation-methodology-help.webp" alt="dissertation-methodology-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
<!---<div class="container">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-methodology-help-faq.php'?>
