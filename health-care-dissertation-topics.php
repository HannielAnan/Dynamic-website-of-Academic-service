...
$sql = "SELECT * FROM  `health-care-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'health-care-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `health-care-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How Can I Check the Status of My Healthcare Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Tracking your order on DissertationWritingHelp is straightforward. Upon confirming your order, you'll receive a unique order code. Feel free to contact us via live chat at any time to check the status of your order."
    }
  },{
    "@type": "Question",
    "name": "How Much Does a Ph.D. Healthcare Dissertation Cost?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Many people wonder about the cost of a Ph.D. dissertation. The price can vary depending on several factors. One of the main factors is the complexity and level of your dissertation. For example, a Ph.D. dissertation may be more expensive than a BSc dissertation."
    }
  },{
    "@type": "Question",
    "name": "How Can I Purchase a Healthcare Dissertation Online?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Purchasing an excellent dissertation is now more convenient than ever. Our dissertation services are readily accessible with just a single click. You can contact us using the live chat feature on our website and connect with our expert consultant at any time. Additionally, you can also reach out to us via email or our contact number. We're here to assist you whenever you need."
    }
  },{
    "@type": "Question",
    "name": "Is it Secure to Purchase a Healthcare Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it is completely secure to buy a dissertation online. You can confidently make an online order and receive a perfectly written dissertation from a professional. When you trust us with your dissertation, you won't need to worry about research or plagiarism. We offer solutions to address all your dissertation concerns, so don't hesitate to place your order now and leave your worries behind."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/health-care-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Range of health care dissertation topics for impactful dissertations that will impress future employers. and Get started on your dissertation journey!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Health Care Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <?php include 'includes/pricing.php'?>
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/health-care-dissertation-topics-faq.php'?>
