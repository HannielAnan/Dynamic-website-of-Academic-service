...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `masters-dissertation-proposal-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `masters-dissertation-proposal-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `masters-dissertation-proposal-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `masters-dissertation-proposal-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `masters-dissertation-proposal-help-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'masters-dissertation-proposal-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `masters-dissertation-proposal-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How can an order be placed on your website?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer four convenient options for placing an order with our services. You have the choice of reaching out to our support team via live chat, sending an email, giving us a call, or simply clicking the \"order now\" button on the website."
    }
  },{
    "@type": "Question",
    "name": "When do your writers commence work on my order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Once payment is submitted and approved on your end, our team of extensively qualified Ph.D. dissertation writers will initiate the work on your order."
    }
  },{
    "@type": "Question",
    "name": "Are there any additional fees for revisions?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "No, there aren't. Our revisions are limitless and come at no extra cost. Our aim is to ensure our customers' satisfaction with our services."
    }
  },{
    "@type": "Question",
    "name": "What is the purpose of crafting a master's dissertation proposal?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A master's dissertation proposal is formulated to obtain approval for conducting a dissertation on the chosen subject. It encompasses the introduction, a brief literature review, the methodology, potential implications, and a list of references."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Get exceptional Masters Dissertation Proposal Help from expert writers. Unique content, 0% plagiarism guarantee. Achieve top grades. Order now</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Buy Masters Dissertation Proposals Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Outstanding-Support-In-Developing-For-Masters-Dissertation-Proposals-Help.webp" alt="masters-dissertation-proposal-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/masters-dissertation-proposal-help-faq.php'?>
