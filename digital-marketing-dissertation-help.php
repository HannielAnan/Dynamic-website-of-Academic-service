...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `digital-marketing-dissertation-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `digital-marketing-dissertation-help-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'digital-marketing-dissertation-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `digital-marketing-dissertation-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is it possible to order using my phone?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Whether you're on a computer or a phone, you can easily access our website and place your order anytime. You can also reach out to us through the provided contact number for more details."
    }
  },{
    "@type": "Question",
    "name": "When can I get my Digital Marketing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our goal is to provide you with a well-crafted dissertation by the set deadline. Although dissertations usually take time, our experts can deliver yours in just a few days. Remember to let us know your deadline when placing the order to ensure a smooth process."
    }
  },{
    "@type": "Question",
    "name": "Can I ask for specific things in my Digital Marketing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Sure! We offer various dissertation services. Whether you need a topic, proofreading, or help with specific chapters, just let us know. We're here to assist you with your dissertation needs."
    }
  },{
    "@type": "Question",
    "name": "Can you check my Digital Marketing dissertation for errors?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! If you've written a dissertation but need help with proofreading and editing, we've got you covered. Our experts will carefully review your work, addressing any mistakes and improving its quality."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Craft your digital marketing dissertation with expert assistance. Skilled writers, unlimited revisions, 25% off on first order. Contact for support!</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Digital Marketing Dissertation Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Assistance-for-Digital-Marketing-Dissertations.webp" alt="digital-marketing-dissertation-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/digital-marketing-dissertation-help-faq.php'?>
