...
$sql = "SELECT * FROM  `strategic-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'strategic-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `strategic-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How to Select an Appropriate Topic for Your Strategic Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Defining a suitable topic can vary between students and professors. To ensure a smooth process, thoroughly understand the guidelines and instructions. Choose a topic that aligns with both the instructions and your interests to facilitate dissertation writing"
    }
  },{
    "@type": "Question",
    "name": "Can Plagiarism Have Adverse Effects on My Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, plagiarism can severely impact your dissertation. Plagiarism constitutes a grave academic offense, involving the use of someone else's work, ideas, or words without proper citation. It can undermine your dissertation's originality and credibility, leading to consequences like lower grades, dissertation rejection, academic suspension, or even expulsion."
    }
  },{
    "@type": "Question",
    "name": "How to Efficiently Write a Strategic Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Composing a Strategic Management dissertation demands time, effort, and careful planning. Employ strategies like creating a clear plan, conducting thorough research, consistent writing, seeking feedback, and utilizing writing tools. While efficiency matters, prioritize quality and academic integrity over speed."
    }
  },{
    "@type": "Question",
    "name": "How to Place an Online Order for an MBA Strategic Management Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Ordering a dissertation is now more convenient than ever. You can initiate an order anytime using the order form on our website. For questions or guidance throughout the ordering process, our 24/7 live chat feature connects you with professional consultants ready to assist you."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/strategic-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore captivating Strategic Management dissertation topics to excel in your academic journey. Our expertly crafted list simplifies topic selection.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Strategic Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <!--?php include 'includes/pricing.php'?>
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/strategic-management-dissertation-topics-faq.php'?>
