...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `phd-dissertation-editing-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-editing-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-editing-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `phd-dissertation-editing-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `phd-dissertation-editing-services-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'phd-dissertation-editing-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `phd-dissertation-editing-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is it possible to monitor the progress of my order for PhD dissertation editing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You have the option to track the status of your order through our customer support system. Feel free to inquire about the completion stage whenever you'd like to know."
    }
  },{
    "@type": "Question",
    "name": "How can I proceed with placing an order for editing my PhD dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To initiate your order, simply click on the 'order now' tab located at the top of the page. This will lead you to our online order form. Additionally, you have the option to reach out to us via Live Chat, WhatsApp, or Direct Call to place your order with ease."
    }
  },{
    "@type": "Question",
    "name": "Who possesses the expertise to proofread my doctoral-level dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We hold the belief that only a seasoned specialist is qualified to undertake dissertation proofreading. For PhD-level dissertations, our team comprises accomplished individuals with dual post-doctoral qualifications, ensuring the meticulous proofreading of your dissertation. They have an eagle eye for identifying both minor and significant issues, guaranteeing the perfection of your dissertation."
    }
  },{
    "@type": "Question",
    "name": "Are your payment methods secure?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We prioritize the safety of our customers' transactions. Our commitment to customer satisfaction is unwavering. We provide a range of secure payment options, including Debit/Credit cards, Bank account transfers, and reliable merchants. Rest assured, all our payment methods are safeguarded and secure. We employ a state-of-the-art 3M data security system and operate on an SSL certified platform to ensure the protection of your sensitive information."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Looking top-notch PhD dissertation editing services? Look no further! Our team of skilled editors specializes in refining your dissertation to perfection</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a PhD Dissertation Editing Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Top-PhD-Dissertation-Editing-Services.webp" alt="Top PHD Dissertation Editing Services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row"> 
    ...
    <div class="content">
      ...
      <p id="mbaallp"><?php echo $parab4;?></p>
       ...
       <h3 onclick="toggleContent(this)"><span class="toggle-icon">+</span><?php echo $headingb5;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/phd-dissertation-editing-services-faq.php'?>
