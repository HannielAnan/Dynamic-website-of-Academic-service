...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `buy-phd-dissertation-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `buy-phd-dissertation-service-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `buy-phd-dissertation-service-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `buy-phd-dissertation-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `buy-phd-dissertation-service-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'buy-phd-dissertation-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `buy-phd-dissertation-service-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can I Track the Progress of My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! You can easily monitor the status of your dissertation order through our customer support system. Whenever you inquire, it will promptly provide updates on the completion stage."
    }
  },{
    "@type": "Question",
    "name": "What is the Delivery Time for the Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time for your dissertation is precisely as per the deadline you specify."
    }
  },{
    "@type": "Question",
    "name": "Do You Have Nursing Experts for PhD Dissertations?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes! Our team includes skilled dissertation experts from various fields, including nursing. They work under the guidance of world-renowned specialists to ensure the delivery of top-quality and innovative nursing dissertations."
    }
  },{
    "@type": "Question",
    "name": "Can You Edit My PhD Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Our team consists of highly certified editors and proofreaders from around the globe. They will diligently edit and correct your PhD dissertation, ensuring it is flawless."
    }
  },{
    "@type": "Question",
    "name": "What's the Grading System for a PhD Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A PhD dissertation is graded as either a pass or a fail. The percentage becomes significant only if it falls below 60%, indicating a failure, while anything above 60% signifies a pass."
    }
  },{
    "@type": "Question",
    "name": "What is the Minimum Passing Score for a PhD Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To pass a PhD dissertation, you must achieve at least 60% marks. Otherwise, you will need to re-submit your dissertation to obtain your degree."
    }
  },{
    "@type": "Question",
    "name": "",
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy PhD Dissertation Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Buy-PhD-Dissertation-Services.webp" alt="Buy PhD Dissertation Services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/buy-phd-dissertation-service-faq.php'?>
