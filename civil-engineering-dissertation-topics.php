...
$sql = "SELECT * FROM  `civil-engineering-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'civil-engineering-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `civil-engineering-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long should I dedicate to brainstorming for suitable civil engineering dissertation topics?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "As the topic is the first element that captures a reader's attention, it is advisable to invest a significant amount of time in brainstorming. To achieve this, extensive reading of relevant literature is essential. The more topics you consider, the greater your chances of discovering an ideal dissertation topic. At 'Dissertation Writing Help' our team of experienced writers is ready to support you in your search for the finest engineering dissertation topics. This service saves you valuable time that can be redirected towards other aspects of your dissertation"
    }
  },{
    "@type": "Question",
    "name": "Where can I find civil engineering dissertation topics for inspiration?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can find a valuable collection of free Civil Engineering Dissertation Examples and Topics to inspire your dissertation ideas. These resources are designed to help you generate original topics and serve as a foundation for your research. Additionally, if you're struggling to find the right civil engineering dissertation topic, you can seek assistance from Dissertation Writing Help, a team of skilled writers and editors with expertise in Civil Engineering, who can guide you toward success. They are available through Live Chat, email, or phone for your"
    }
  },{
    "@type": "Question",
    "name": "Why do I need to choose a dissertation topic in civil engineering?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "In the field of Civil Engineering, just like any other degree, you're required to submit a dissertation. This is how your institution assesses your research skills and evaluates what you've learned during your years of study. A dissertation is not a simple essay that can be written in a few hours. It's a complex project that can take months or even years for doctoral degrees. Finding suitable PhD topics in civil engineering can be challenging due to various factors, including its intricate structure."
    }
  },{
    "@type": "Question",
    "name": "How Can I Get Assistance in Choosing the Right Civil Engineering Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "If you're struggling to find the ideal civil engineering dissertation topic, you can seek guidance from Dissertation Writing Help. Their team consists of skilled writers and editors with expertise in Civil Engineering who are ready to assist you in selecting the perfect topic that suits your needs. You can reach out to them through various channels, including starting a conversation with their Live Chat Agent for instant assistance, sending an email, or making a phone call. Their responsive customer support team is available to help you throughout the process of topic selection."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/civil-engineering-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Civil engineering dissertation topics and get expert guidance on choosing the right one for your dissertation. Contact us today for assistance.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Civil Engineering Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
...
<div class="container">
  <div class="row"> 
    <div class="col-lg-12">
      ...
      <h2 onclick="toggleContent2(this)"><span class="toggle-icon">+</span> <?php echo $headingb2; ?></h2>
       <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab2; ?></p>
      </div>
      <h2 onclick="toggleContent2(this)"><span class="toggle-icon">+</span> <?php echo $headingb3; ?></h2>
    <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab3; ?></p>
    </div>
    
      <h2 onclick="toggleContent2(this)"><?php echo $headingb4;?></h2>
         <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab4;?></p>
      </div>
       <h2 onclick="toggleContent2(this)"><?php echo $headingb5;?></h2>
         <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab5;?></p>
      </div>  
      <h2 onclick="toggleContent2(this)"><?php echo $headingb6;?></h2>
         <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab6;?></p>
       
      </div>
     <h2 onclick="toggleContent2(this)"><?php echo $headingb7;?></h2>
         <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab7;?></p>
      </div>
      <h2 onclick="toggleContent2(this)"> <?php echo $headingb8;?></h2>
         <div class="content2 collapsed">
      <p id="mbaallp"><?php echo $parab8;?></p>
      </div>
           <h2 onclick="toggleContent2(this)"> <?php echo $headingb9;?></h2>
         <div class="content2 collapsed">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/civil-engineering-dissertation-topics-faq.php'?>
