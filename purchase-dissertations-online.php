...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `purchase-dissertations-online-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `purchase-dissertations-online-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `purchase-dissertations-online-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `purchase-dissertations-online-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `purchase-dissertations-online-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'purchase-dissertations-online';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `purchase-dissertations-online-title_and-description` WHERE page_identifier = '$pageIdentifier'";
          ...
          <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! You can acquire a master's dissertation paper from us as we cater to all academic levels, including Ph.D. Our writers hold either master's or PhD degrees in their respective fields"
    }
  },{
    "@type": "Question",
...
<body>
   ...
   <p class="hidden">Get top-quality custom-written dissertations from Purchase-Dissertation-Online. Explore various topics, ensure timely delivery, and secure academic success</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Purchase Dissertation Online</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Purchase-Dissertations-Online-From-The-Best-Tutors.webp" alt="purchase dissertations online" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/purchase-dissertations-online-faq.php'?>
