...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `business-management-dissertation-editing-and-proofreadiblack-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `business-management-dissertation-editing-and-proofr-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `business-management-dissertation-editing-and-proofr-3b-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `business-management-dissertation-editing-and-proof-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `business-management-dissertation-editing-and-pro-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'business-management-dissertation-editing-and-proofreading-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `business-management-dissertation-editing-antitle_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<body>
    ...
    <p class="hidden">Ph.D. experts craft original business management dissertation proofreading for quality. Native writers excel in excellence.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a Business Management Dissertation Editing and Proofreading Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Proofreading-Services-for-Business-Management.webp" title="Proofreading-Services-for-Business-Management" alt="Proofreading-Services-for-Business-Management" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/business-management-dissertation-editing-and-proofreading-services-faq.php'?>
