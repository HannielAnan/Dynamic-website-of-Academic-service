...
$sql = "SELECT * FROM  `nursing-dissertation-topics-dementia-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'nursing-dissertation-topics-dementia';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `nursing-dissertation-topics-dementia-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our payment methods stand out for their safety and global acceptance. We prioritize your security. You can make payments using Credit Cards, Debit Cards, Secure Merchants, and Registered Bank Accounts. Rest assured, all our payment methods are protected by a robust 3M data security system. If you have any questions or concerns, our live chat support is available at your convenience."
    }
  },{
    "@type": "Question",
    "name": "How Can I Check the Status of My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Tracking your dissertation order on DissertationWritingHelp is a breeze. Once your order is confirmed, you'll receive an order code. You can use this order code to monitor your order's progress through our website's live chat feature."
    }
  },{
    "@type": "Question",
    "name": "How Do I Place an Order for My Dementia Nursing Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Ordering your dissertation has never been more convenient. Simply reach out to us using our 24/7 live chat feature. Our highly qualified consultants are ready to assist you and provide guidance on placing your dissertation order online. You can also contact us via email or our contact number for further assistance."
    }
  },{
    "@type": "Question",
    "name": "Can Plagiarism Lead to the Rejection of My Dementia Nursing Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Plagiarism stands as a significant reason for dissertation rejection. It's crucial to steer clear of copying content from any source. When referencing existing research, ensure proper attribution to the author or researcher. If you encounter difficulties in producing a plagiarism-free dissertation, don't hesitate to contact us. Our team of field experts is ready to assist you in crafting a high-quality dissertation at the most competitive prices."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/nursing-dissertation-topics-dementia.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore a list of nursing dissertation topics for dementia that can make a positive impact on patients' lives. Handpicked ideas by experts in the field.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Nursing Dissertation Topics Dementia</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/nursing-dissertation-topics-dementia-faq.php'?>
