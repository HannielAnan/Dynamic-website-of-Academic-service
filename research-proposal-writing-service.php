...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `research-proposal-writing-service-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `research-proposal-writing-service-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `research-proposal-writing-service-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `research-proposal-writing-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `research-proposal-writing-service-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'research-proposal-writing-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `research-proposal-writing-service-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<body>
    ...
    <p class="hidden">Acquire premier research proposal service. Buy proposals with 25% off 1st order. Contact +44 7564 313 614 or info@dissertationwritinghelp.net.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Research Proposal Writing Service</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Premier-PhD-Research-Proposal-Writing-Service-Available.webp" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/research-proposal-writing-service-faq.php'?>
