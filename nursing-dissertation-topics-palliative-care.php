...
$sql = "SELECT * FROM  `nursing-dissertation-topics-palliative-care-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'nursing-dissertation-topics-palliative-care';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `nursing-dissertation-topics-palliative-car-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What payment options are available for your services?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer a range of convenient and hassle-free payment methods to ensure that every student can access our services at their convenience. Our payment options include Credit Cards, Debit Cards, Secure Merchants, and Registered Bank Account Transfer. If you have any questions about payment, feel free to contact our 24/7 live chat support, where our consultants are ready to assist you."
    }
  },{
    "@type": "Question",
    "name": "Is it secure to order a dissertation online from DissertationWritingHelp?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Rest assured, ordering a dissertation online through DissertationWritingHelp is a secure process. We prioritize the confidentiality of your data by utilizing advanced encryption software, ensuring that only our team has access to your information. Your identity remains completely anonymous throughout the process, so you can order with confidence."
    }
  },{
    "@type": "Question",
    "name": "Can I request a palliative care nursing dissertation with a one-week turnaround time?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! You have the option to place an order for a palliative care nursing dissertation just one week before your submission deadline. Our dedicated team of professional writers will make every effort to deliver your dissertation as quickly as possible. Whether it's an MSc, BSc, or even a PhD dissertation, we strive to provide a prompt delivery service."
    }
  },{
    "@type": "Question",
    "name": "Why is the selection of a compelling palliative care nursing dissertation topic crucial?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The significance of selecting a captivating and impactful dissertation topic cannot be overstated. To begin with, your dissertation title plays a critical role in creating the initial impression of your work. Anyone considering reading your dissertation will likely form judgments based on the title or topic alone. Moreover, all your dissertation topics will be listed on your resume, making it important for potential employers who may assess you based on your chosen topic."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/nursing-dissertation-topics-palliative-care.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
  ...
  <p class="hidden">Explore engaging nursing dissertation topics in palliative care, carefully curated to help students choose the perfect subject for their academic journey.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Nursing Dissertation Topics Palliative Care</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/nursing-dissertation-topics-palliative-care-faq.php'?>
