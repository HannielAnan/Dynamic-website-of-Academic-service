...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-editing-and-proofreading-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-editing-and-proofreading-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-editing-and-proofreading-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-editing-and-proofreading-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-editing-and-proofreading-services-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-editing-and-proofreading-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-editing-and-proofreading-serv-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is It Possible to Monitor the Progress of My Dissertation Editing and Proofreading Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You have the ability to track your order using our customer support system. Whenever you inquire, it will update you on the stage of completion your order has reached."
    }
  },{
    "@type": "Question",
    "name": "Who Will Proofread My PhD Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Your dissertation will be proofread by certified proofreaders who possess years of experience and double doctorate qualifications. Our field specialists, regardless of the topic or domain, are always prepared to edit and proofread your dissertation, ensuring impeccable results."
    }
  },{
    "@type": "Question",
    "name": "What Is the Role of a Dissertation Proofreader?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A dissertation proofreader carefully examines your entire dissertation. They go through each section thoroughly to identify any errors, problems, or mistakes. Proofreading is an excellent method to uncover errors in your dissertation. Subsequently, our top editors will make further refinements during the editing process."
    }
  },{
    "@type": "Question",
    "name": "What's the Timeframe for Editing a Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The time required for editing a dissertation varies based on its word count. For instance, if the dissertation is around 25,000 words, the editing process might take approximately 2 weeks. However, if you need it sooner, we also offer expedited editing services for urgent requests."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Seeking top-notch dissertation proofreading and editing services? Look no further! Our certified proofreaders ensure your work is flawless and error-free.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Editing and Proofreading Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/High-Quality-Dissertation-Proofreading-and-Editing-Services.webp" alt="dissertation-editing-and-proofreading-services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
<!---<div class="container">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-editing-and-proofreading-services-faq.php'?>
