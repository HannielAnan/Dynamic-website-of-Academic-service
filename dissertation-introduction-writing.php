...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-introduction-writing-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-introduction-writing-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-introduction-writing-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-introduction-writing-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-introduction-writing-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-introduction-writing';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-introduction-writing-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Will You Help with My Dissertation Introduction?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We're here to assist you with your dissertation introduction. Whether you need just the introduction chapter or the entire dissertation, we're more than happy to help with both options."
    }
  },{
    "@type": "Question",
    "name": "Is the Problem Statement Included in the Introduction?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, the problem statement is typically a part of the first chapter of the introduction of a dissertation."
    }
  },{
    "@type": "Question",
    "name": "Can I Keep Track of My Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You have the option to track your order through our customer support system. Feel free to ask about the progress of your order, and we'll provide you with updates on its completion stage."
    }
  },{
    "@type": "Question",
    "name": "What Headings Are Included in the Introduction Chapter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The introduction chapter of your dissertation typically includes headings like background theory, problem statement, research objective, research question, limitation of the study, and significance of the study."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Dissertation Introduction Writing Service | Craft a flawless introduction with our easy reference generator, abundant research resources. get 25% discount</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Introduction Service</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/dissertation-introduction-writing.webp" id="subpagebanner" alt="dissertation-introduction-writing" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-introduction-writing-faq.php'?>
