...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `buy-master-dissertation-service-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `buy-master-dissertation-service-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `buy-master-dissertation-service-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `buy-master-dissertation-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `buy-master-dissertation-service-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'buy-master-dissertation-service';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `buy-master-dissertation-service-title_and-description` WHERE page_identifier = '$pageIdentifier'";
  ...
  <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Can I Monitor My Dissertation Order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! You can easily track the progress of your order through our customer support system, which will promptly update you on the completion stage whenever you inquire."
    }
  },{
    "@type": "Question",
    "name": "How Long is the Dissertation Delivery Time?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time for your dissertation is precisely as per your specified deadline."
    }
  },{
    "@type": "Question",
    "name": "Do You Have Nursing Experts for Master Dissertations?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes! We have a panel of dissertation experts from various fields, including nursing, who work under the guidance of world-renowned specialists. Our nursing dissertation experts ensure the delivery of top-quality and innovative dissertations."
    }
  },{
    "@type": "Question",
    "name": "Can You Edit My Master Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Our team comprises highly certified editors and proofreaders from around the globe, who will diligently edit and correct your master's dissertation, ensuring it is flawless."
    }
  },{
    "@type": "Question",
    "name": "What's the Highest Grade for a master's Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A master's dissertation is graded as either a pass or fail. The percentage matters only if it falls below 60%, indicating a failure, while above 60% signifies a pass."
    }
  },{
    "@type": "Question",
    "name": "What is the Minimum Passing Score for a master's Dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To pass a master's dissertation, you must achieve at least 60% marks. Otherwise, you will need to re-submit your dissertation to obtain your degree."
    }
  },{
    "@type": "Question",
    "name": "",
...
<?php include 'googlebodycode.php'; ?>
    <p class="hidden">Obtain high-quality online master's dissertations from expert writers. Get professional help and exceptional quality for academic success. Get help today.</p>
  ...
  <i class="fa-solid fa-check" id="allcheckicon"></i> <?php echo $freeTopics[2] ?? ''; ?>
        ...
        <div class="d-flex align-items-center justify-content-center" id="formdiv">
              <form class="form" method="POST" id="formentry">
                ...
                <div class="row mb-3">
                    <input type="hidden" method="POST" class="form-control" name="page" value="https://dissertationwritinghelp.net/buy-master-dissertation-services">
...
<div class="container">
  <div class="row align-items-stretch">
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box1" class="col-box h-100">
        <i class="fontawesome-icon fa-star far circle-no" id="font3"></i>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box2" class="col-box h-100">
        <i class="fontawesome-icon fa-file far circle-no" id="font3"></i>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box3" class="col-box h-100">
        <i class="fontawesome-icon fa-hand-holding-usd fas circle-no" id="font3"></i>
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy Master Dissertation Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Buy-Master-Dissertation-Services-Online-at-Cheap-Rates.webp" alt="Buy Master Dissertation Services Online at Cheap-Rates" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/buy-master-dissertation-services-faq.php'?>
