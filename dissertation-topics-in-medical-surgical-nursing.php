...
$sql = "SELECT * FROM  `dissertation-topics-in-medical-surgical-nursing-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'dissertation-topics-in-medical-surgical-nursing';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-topics-in-medical-surgical-nu-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How soon can I expect to receive my medical-surgical nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time depends on various factors, including the nature and topic of your dissertation. Please specify your deadline, and our writers will work accordingly. In some cases, you can receive your dissertation in just a few hours. Rest assured, our experts are here to manage your dissertation efficiently."
    }
  },{
    "@type": "Question",
    "name": "How much does a BSc medical surgical nursing dissertation cost?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The price of a dissertation can vary based on several factors. For instance, a Ph.D. dissertation would typically be priced higher than a BSc dissertation due to its length and research complexity. However, rest assured that all our prices are budget-friendly and affordable, so you can confidently place your order.
The price of a dissertation can vary based on several factors. For instance, a Ph.D. dissertation would typically be priced higher than a BSc dissertation due to its length and research complexity. However, rest assured that all our prices are budget-friendly and affordable, so you can confidently place your order."
    }
  },{
    "@type": "Question",
    "name": "How do I pick the best topic for my medical-surgical nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Selecting the best topic for your medical-surgical nursing dissertation requires careful consideration. To make the right choice, keep your professor's guidelines in mind. It's essential to pick a topic that aligns with your personal interests and has some prior research but avoid selecting one that has been extensively explored to maintain the authenticity of your dissertation."
    }
  },{
    "@type": "Question",
    "name": "Is purchasing a medical-surgical nursing dissertation costly?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "At DissertationWritingHelp, our top priority is ensuring our clients' satisfaction. We recognize that high-priced services may not be affordable for many students. That's why we offer high-quality dissertation writing services at affordable prices. So, don't dwell on the cost; go ahead and place an order to alleviate all your concerns and troubles."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/dissertation-topics-in-medical-surgical-nursing.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">List of free dissertation topics in medical-surgical nursing for impactful dissertation. These ideas can be customized and impress your audience.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Dissertation Topics in Medical Surgical Nursing</h1>
            </div>
        </div>
    </div>
  ...
  <?php include 'includes/pricing.php'?>
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-topics-in-medical-surgical-nursing-faq.php'?>
