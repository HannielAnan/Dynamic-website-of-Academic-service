...
$sql = "SELECT * FROM  `luxury-brand-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'luxury-brand-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `luxury-brand-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Placing an order is easy. You can click the \"Order Now\" button, chat with us live, or send us an email."
    }
  },{
    "@type": "Question",
    "name": "How can I improve my dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To enhance your dissertation, focus on using proper citations, correct formatting, and scholarly language relevant to your topic."
    }
  },{
    "@type": "Question",
    "name": "How do I choose the right luxury brand dissertation topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To select the best topic, start by generating an idea based on a lingering problem in your research field. Ensure your dissertation clearly answers the research question to showcase your efforts to your instructor."
    }
  },{
    "@type": "Question",
    "name": "What's the word count for a luxury brand dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Dissertation word counts can vary, but as a general guideline, MBA luxury brand dissertations are typically 15,000 - 20,000 words, while Ph.D. dissertations should be under 80,000 words."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/luxury-brand-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore exclusive Luxury Brand Dissertation Topics and ideas to make your dissertation exceptional Get expert assistance for a distinctive research journey</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Luxury Brand Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/luxury-brand-dissertation-topics-faq.php'?>
