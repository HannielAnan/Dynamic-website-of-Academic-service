...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `buy-dissertation-online`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `buy-dissertation-service-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `buy-dissertation-service-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `buy-dissertation-service-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `buy-dissertation-service-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'buy-dissertation-online';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `buy-dissertation-online-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What is the typical length of a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The length of a dissertation largely hinges on how you structure your chapters, but the average dissertation is around 100 pages. While this project can be quite extensive, many students choose to purchase dissertation chapters in order to alleviate the burden of this extensive task.\""
    }
  },{
    "@type": "Question",
    "name": "Is it possible to purchase a master's level dissertation paper?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! You can acquire a master's dissertation paper from us as we cater to all academic levels,"
    }
  },{
    "@type": "Question",
    "name": "Why should you choose us as your preferred source for purchasing dissertation writing services?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Our adept and seasoned PhD dissertation writers have consistently achieved outstanding grades for students with our dissertation services. With round-the-clock customer support, we ensure that any query is swiftly resolved, setting us apart as the top choice among all.\""
    }
  },{
    "@type": "Question",
    "name": "Is it possible to purchase affordable dissertations online?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, you can acquire budget-friendly dissertations online from our platform. Our pricing structure is tailored to accommodate student budgets. Additionally, you'll receive a 25% discount on your initial order. Furthermore, we regularly introduce special discount offers during occasions such as Christmas, Halloween, New Year, and more."
    }
  },{
    "@type": "Question",
    "name": "",
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WX573PJH"
  ...
  <i class="fa-solid fa-check" id="allcheckicon"></i> <?php echo $freeTopics[2] ?? ''; ?>
        ...
        <div class="d-flex align-items-center justify-content-center" id="formdiv">
              <form class="form" method="POST" id="formentry">
                ...
                <div class="row mb-3">
                    <input type="hidden" method="POST" class="form-control" name="page" value="buy-dissertation-online">
...
<div class="container">
  <div class="row align-items-stretch">
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box1" class="col-box h-100">
        ...
        <h4 id="allh4"><?php echo $box1_title; ?></h4>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box2" class="col-box h-100">
        ...
        <h4 id="allh4"><?php echo $box2_title; ?></h4>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div id="box3" class="col-box h-100">
        ...
        <h4 id="allh4"><?php echo $box3_title; ?></h4>
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to Buy Dissertation Online</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <img src="images/Buy-Dissertations-Online.webp" id="subpagebanner" class="img-fluid" alt="Buy Dissertation Online">
        </div>
    </div>
</div>
...
<div class="container">
  <div class="row"> 
    <div class="col-lg-12">
      ...
      <h3 onclick="toggleContent(this)"><span class="toggle-icon">+</span> <?php echo $headingb2; ?></h3>
       <div class="content">
      ...
      <h3 onclick="toggleContent(this)"><span class="toggle-icon">+</span> <?php echo $headingb3; ?></h3>
    <div class="content">
      <p id="mbaallp"><?php echo $parab3; ?></p>
    </div>
     
      <h3 onclick="toggleContent(this)"><span class="toggle-icon">+</span> <?php echo $headingb4;?></h3>
         <div class="content">
      <p id="mbaallp"><?php echo $parab4;?></p>
      </div>
       <h3 onclick="toggleContent(this)"> <?php echo $headingb5;?></h3>
         <div class="content">
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/buy-dissertation-online-faq.php'?>
