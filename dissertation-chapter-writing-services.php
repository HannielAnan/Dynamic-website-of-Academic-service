...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `dissertation-chapter-writing-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-chapter-writing-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `dissertation-chapter-writing-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `dissertation-chapter-writing-services-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `dissertation-chapter-writing-services-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'dissertation-chapter-writing-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `dissertation-chapter-writing-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How quickly can you write my dissertation conclusion chapter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We're here to work at your pace. Tell us when you need your conclusion chapter, and we'll ensure it's ready by then. We promise on-time delivery, always."
    }
  },{
    "@type": "Question",
    "name": "Do I have to pay extra for revisions?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "No, revisions are part of our service. You won't be charged extra beyond the initial fee mentioned."
    }
  },{
    "@type": "Question",
    "name": "Can I know the progress of my order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! Our customer support system lets you track your order's progress. Just ask, and we'll keep you updated on its status."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We make sure your payments are secure and affordable. You can use Credit Cards, Debit Cards, Secure merchants, and registered bank accounts. Your transactions are protected by a reliable 3M data security system."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Get expert help for dissertation chapters! Top-notch writing & unique. 25% off 1st order. Contact: +44 7564 313 614 or info@dissertationwritinghelp.net.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple process to buy Dissertation Chapter Writing Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Get-Help-with-Your-Dissertation-Chapters-Writing-Services.webp" alt="dissertation-chapter-writing-services" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-chapter-writing-services-faq.php'?>
