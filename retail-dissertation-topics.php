...
$sql = "SELECT * FROM  `retail-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'retail-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `retail-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We offer various payment methods, including Bank transfer, PayPal, Paynote, and all major Debit/credit cards."
    }
  },{
    "@type": "Question",
    "name": "Will you handle the entire dissertation for me?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! Our highly qualified dissertation specialists are well-equipped to handle your entire dissertation. With Ph.D. and double doctorate qualified writers on our team, no subject is too challenging for us."
    }
  },{
    "@type": "Question",
    "name": "What are the advantages of selecting a retail dissertation topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Opting for a retail dissertation topic can open doors to employment opportunities in top FMCG (Fast Moving Consumer Goods) companies in the UK, such as Unilever and P&G. These organizations indirectly collaborate with retailers to enhance their business, making a retail dissertation invaluable for understanding the market dynamics."
    }
  },{
    "@type": "Question",
    "name": "Could you explain retail marketing and how you approach writing-related topics?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Retail marketing involves strategies employed by retail stores to attract new customers, relying on concepts like the 4 P's and conventional marketing techniques to drive sales. Crafting a retail dissertation topic necessitates profound subject knowledge. We begin by reviewing your requirements and then infuse our industry expertise into your dissertation for a comprehensive and insightful result."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/retail-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore Retail Dissertation Topics and Ideas, including the impact on marketing strategies. Get academic success with our Ph.D.-qualified writers!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Retail Dissertation Topics Sales Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/retail-dissertation-topics-faq.php'?>
