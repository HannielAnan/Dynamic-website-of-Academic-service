...
$query = "SELECT `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`, `question7`, `answer7`,`question8`, `answer8`, `question9`, `answer9`  FROM `accounting-dissertation-editing-and-proofreading-services-faq`";
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <?php if (!empty($data['question4']) && !empty($data['answer4'])) { ?>
                <div class="question">
                  <button id="question">
                    <span><?php echo $data['question4']; ?></span>
                    <i class="fas fa-chevron-down d-arrow"></i>
                  </button>
