...
$query = "SELECT `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`,  `question7`, `answer7`, `question8`, `answer8`     FROM `index11`";
...
<!-- faq container start -->
<div class="container" id="faqss">
  <div class="row">
    <div class="col-lg-12" style="padding-bottom:20px">
    <h3 class="title custom-heading"><?php echo $data['heading']; ?></h3>
    </div>
  </div>
  <div class="row">
    ...
    <section>
        ...
        <div class="questions-container">
          ...
          <div class="question">
            <button id="question">
              <span id="answer"><?php echo $data['question1']; ?></span>
          ...
          <div class="question">
            <button id="question">
              <span><?php echo $data['question2']; ?></span>
              <i class="fas fa-chevron-down d-arrow"></i>
            </button>
    ...
    <div class="col-lg-6">
          ...
          <?php } ?>
          <?php if (!empty($data['question6']) && !empty($data['answer5'])) { ?>
          <div class="question">
            <button id="question">
          ...
          <?php } ?>
          <?php if (!empty($data['question7']) && !empty($data['answer5'])) { ?>
          <div class="question">
            <button id="question">
          ...
          <?php } ?>
          <?php if (!empty($data['question8']) && !empty($data['answer5'])) { ?>
          <div class="question">
            <button id="question">
