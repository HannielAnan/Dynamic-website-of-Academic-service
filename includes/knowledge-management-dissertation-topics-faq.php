<!--<ul class="list" style="background-color: #000; margin-left: 10px; padding-top: 25px; padding-bottom: 25px; border-left: 2px solid; border-color: red;">
            <h4 class="list-heading" style="color: white; padding-left: 10px; background-color: #000; padding-bottom: 10px;font-family: Roboto;font-weight: 600;" id="besth4">
  ?php echo $boxContent; ?>
</h4>

<li class="list-item" style="text-decoration: none; list-style: none; color: white;" id="free">
  <i class="fa-solid fa-check"></i> ?php echo $freeTopics[2] ?? ''; ?>
</li>
<li class="list-item" style="text-decoration: none; list-style: none; color: white;" id="free">
  <i class="fa-solid fa-check"></i> ?php echo $freeTopics[3] ?? ''; ?>
</li>
<li class="list-item" style="text-decoration: none; list-style: none; color: white;" id="free">
  <i class="fa-solid fa-check"></i> ?php echo $freeTopics[4] ?? ''; ?>
</li>
            </ul>-->
<?php
include 'dbconnection/dbconnect.php';

$query = "SELECT `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`, `question7`, `answer7`,`question8`, `answer8`, `question9`, `answer9`  FROM `knowledge-management-dissertation-topics-faq`";
            ...
            <div class="col-lg-6">
             ...
             <!-- ?php if (!empty($data['question5']) && !empty($data['answer5'])) { ?>
              ...
              <?php if (!empty($data['question6']) && !empty($data['answer6'])) { ?>
                <div class="question">
                  <button id="question">
                    <span id="question3"><?php echo $data['question6']; ?></span>
                    <i class="fas fa-chevron-down d-arrow"></i>
                  </button>
