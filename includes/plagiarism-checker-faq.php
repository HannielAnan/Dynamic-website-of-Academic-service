...
$query = "SELECT `heading`, `question1`, `answer1`, `question2`, `answer2`, `question3`, `answer3`, `question4`, `answer4`, `question5`, `answer5`, `question6`, `answer6`, `question7`, `answer7`,`question8`, `answer8`  FROM `plagiarism-checker-faq`";
...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <section>
        <h4 id="h4">Plagiarism Checker FAQ</h4>
          ...
          <div class="row">
            <div class="col-lg-6">
              <?php if (!empty($data['question1']) && !empty($data['answer1'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer1']; ?></p>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($data['question2']) && !empty($data['answer2'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer2']; ?></p>
                </div>
              <?php } ?>
            ...
            <div class="col-lg-6">
                ...
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer3']; ?></p>
                </div>
              <?php } ?>
              <?php if (!empty($data['question4']) && !empty($data['answer4'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer4']; ?></p>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($data['question5']) && !empty($data['answer5'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer5']; ?></p>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($data['question6']) && !empty($data['answer6'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer6']; ?></p>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($data['question7']) && !empty($data['answer7'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer7']; ?></p>
                </div>
              <?php } ?>
              ...
              <?php if (!empty($data['question8']) && !empty($data['answer8'])) { ?>
                <div class="question">
                  ...
                  <p id="faqp"><?php echo $data['answer8']; ?></p>
                </div>
              <?php } ?>
            </div>
          </div>
