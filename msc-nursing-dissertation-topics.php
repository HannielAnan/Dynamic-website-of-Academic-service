...
$sql = "SELECT * FROM  `msc-nursing-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Is it possible to receive a plagiarism report along with my dissertation order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "report along with my dissertation order? Absolutely! Our team of experts in the field ensures that all our dissertations are entirely original. To confirm the authenticity of our dissertations, we offer a plagiarism-free guarantee! Therefore, feel confident in purchasing a dissertation without any concerns about its originality and genuineness."
    }
  },{
    "@type": "Question",
    "name": "Is the cost of purchasing a dissertation high?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The expense of obtaining a dissertation can fluctuate significantly based on several key factors, including its complexity, subject matter, and the academic level at which it is written. For example, a PhD dissertation might be more costly than a BSc dissertation. However, even though dissertation writing can be quite costly, DissertationWritingHelp offers top-quality services at remarkably affordable rates. You can confidently acquire a dissertation from us without any concerns about your budget!"
    }
  },{
    "@type": "Question",
    "name": "Is the cost of purchasing a dissertation high?",
    ...
    "@type": "Question",
    "name": "Is it possible to receive a failing grade for my MSc nursing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Several factors can potentially have an adverse impact on your dissertation. While it is within the realm of possibility to fail your dissertation, you have the opportunity to make the necessary revisions and resubmit it for evaluation. However, it is strongly advised to take precautions and avoid any circumstances that could negatively affect your dissertation. One significant factor to watch out for is plagiarism. It is never acceptable to reproduce or borrow someone else's research or content without providing proper attribution. Strive to maintain the"
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/Nursing-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Struggling to choose MSc nursing dissertation topics? Inspiring ideas and expert guidance. get answers to common queries. Contact at +44 7564 313 614 </p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">MSc Nursing Dissertation Topics</h1>
            </div>
        </div>
    </div>
