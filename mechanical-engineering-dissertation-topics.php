...
$sql = "SELECT * FROM  `mechanical-engineering-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'mechanical-engineering-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `mechanical-engineering-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Why are Mechanical Engineering Dissertation Topics Important?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Mechanical Engineering Dissertation Topics are crucial in the academic journey of engineering students. They require extensive research and a deep understanding of the subject. Unlike some subjects, mechanical engineering demands careful consideration when selecting topics. It encompasses a wide range of areas, such as materials science, thermodynamics, electricity, structural analysis, dynamics, and mechanics. Choosing the right topic is essential, striking a balance between relevance, depth, and breadth."
    }
  },{
    "@type": "Question",
    "name": "Where Can I Find Free Mechanical Engineering Dissertation Topics?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can explore various free PhD topics in mechanical engineering. These topics cover a range of areas, from the impact of the COVID-19 pandemic on mechanical engineers to in-depth examinations of mechanical properties and applications of materials. These topics offer diverse research opportunities for your mechanical engineering dissertation."
    }
  },{
    "@type": "Question",
    "name": "How Can Dissertation Writing Help Assist with Choosing Mechanical Engineering Dissertation Topics?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What Is the Process for Creating Mechanical Engineering Dissertation Topics?",
    "acceptedAnswer": {
      "@type": "Answer",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/mechanical-engineering-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Mechanical engineering dissertation topics discover why choosing the right one matters. Expert assistance for your journey with Dissertation Writing Help.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Mechanical Engineering Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/mechanical-engineering-dissertation-topics-faq.php'?>
