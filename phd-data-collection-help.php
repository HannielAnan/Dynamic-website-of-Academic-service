...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `phd-data-collection-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `phd-data-collection-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `phd-data-collection-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `phd-data-collection-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `phd-data-collection-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'phd-data-collection-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `phd-data-collection-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Are there undisclosed fees?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We have a transparent policy and do not impose any additional costs. All our prices and charges are openly stated."
    }
  },{
    "@type": "Question",
    "name": "How do I proceed with placing my order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To initiate your order, simply click on the 'Order Now' tab located at the top of the screen. This will guide you to our online order form."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time aligns with the specific timeframe you indicate for your dissertation submission"
    }
  },{
    "@type": "Question",
    "name": "What's the typical duration for completing a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The timeline varies based on the dissertation's specifications. Generally, crafting a dissertation can take around one to two months, although our experts are also capable of meeting tighter deadlines."
    }
  }]
}
</script>
...
<body>
    ...
    <p class="hidden">Optimize PhD research: Expertly gather, analyze vital data with our advanced Data Collection Solutions. Elevate insights through tailored approach.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a PhD Data Collection Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Optimal-Assistance-for-PhD-Data-Collection-Help.webp" alt="phd-data-collection-help" id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/phd-data-collection-help-faq.php'?>
