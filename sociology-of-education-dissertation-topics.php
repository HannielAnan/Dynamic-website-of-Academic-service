...
$sql = "SELECT * FROM  `sociology-of-education-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'sociology-of-education-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `sociology-of-education-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How to Discover the Ideal Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Unearthing a captivating dissertation topic often necessitates practical experience. If you're a full-time student, seeking guidance from industry experts is highly beneficial. Consider consulting friends or family members employed in your research field to identify underlying issues. Once you've identified a problem, you can formulate your dissertation topic around it."
    }
  },{
    "@type": "Question",
    "name": "What's the Typical Timeframe for Dissertation Writing?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "There isn't a fixed timeline for completing a dissertation. The duration varies depending on your chosen topic and your level of expertise in the subject matter. However, selecting a topic that aligns with your passion can expedite the writing process."
    }
  },{
    "@type": "Question",
    "name": "Is Including Acknowledgments in My Dissertation Essential?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "While not obligatory, acknowledgments are a customary section in your introductory chapter where you express gratitude to your instructor and anyone who assisted you during your research. Although not mandatory, showing appreciation is highly regarded within dissertation committees."
    }
  },{
    "@type": "Question",
    "name": "Can I Request a Single Dissertation Chapter?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, you can. Our goal is to alleviate the academic stress that students may encounter. That's why we're committed to serving students to the best of our ability, including providing individual dissertation chapters upon request."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/sociology-of-education-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Explore expertly crafted sociology of education dissertation topics and ideas to spark your research. Discover tailored topics and get assistance 24/7.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Sociology of Education Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/sociology-of-education-dissertation-topics-faq.php'?>
