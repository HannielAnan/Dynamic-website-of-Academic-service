...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `secondary-data-collection-help-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `secondary-data-collection-help-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `secondary-data-collection-help-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `secondary-data-collection-help-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `secondary-data-collection-help-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'secondary-data-collection-help';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `secondary-data-collection-help-title_and-description` WHERE page_identifier = '$pageIdentifier'";
      ...
      <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Are There Any Concealed Fees?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We are completely transparent and do not impose any additional costs. Our pricing and charges are openly shared and free from hidden fees."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To place your order, simply click on the 'order now' tab located at the top of the screen. This will direct you to our online order form."
    }
  },{
    "@type": "Question",
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The delivery time for your dissertation order will match the duration you specify for its submission."
    }
  },{
    "@type": "Question",
    "name": "Is it possible to hire someone for secondary data collection assistance in my vicinity?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "You can conveniently avail ourselves of our expertly designed secondary data collection help. Our team comprises industry leaders with extensive experience and qualifications in secondary data collection. Regardless of your specific requirements or academic field, our assistance is available round the clock. Obtain secondary data collection and analysis support at an affordable price anytime you need."
    }
  },{
    "@type": "Question",
    "name": "How quickly can you gather secondary data on my behalf?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "We can work at your desired pace. Our services are tailored to accommodate urgent requests for secondary data collection help. The collection of secondary data can be aligned with your specified timeframe. We also accommodate last-minute orders."
    }
  },{
    "@type": "Question",
    "name": "",
...
@media screen and (min-width: 1360px) and (max-width: 1360px) and (min-height: 768px) and (max-height: 768px) {
  #census{
        margin-top: 85px;
    }
}
...
<body>
   ...
   <p class="hidden">Elevate research with expert Expert Secondary Data Collerction Help. Unlock well-structured, successful outcomes through best practices and effective guidance."</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a Secondary Data Collection Help</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="row">
<div class="col-lg-12">
<img src="images/Assistance-with-Secondary.webp" id="subpagebanner" class="img-fluid" alt="secondary-data-collection-help">
</div>
</div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/secondary-data-collection-help-faq.php'?>
