...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `digital-marketing-dissertation-editing-and-proofreadin-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-editing-and-proofrea-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-editing-and-proofrea-3b-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `digital-marketing-dissertation-editing-and-proofre-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `digital-marketing-dissertation-editing-and-proof-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'digital-marketing-dissertation-editing-and-proofreading-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `digital-marketing-dissertation-editing-and-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "What Our Digital Marketing Dissertation Editing Expertise?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Distinguishing our digital marketing dissertation editing services lies in our adept team of dissertation specialists. Proficient across diverse dissertation formats, we stand proud as leaders in academia. Boasting a remarkable track record of 2000+ edited dissertations, our services set the standard for excellence and originality in the field."
    }
  },{
    "@type": "Question",
    "name": "Looking to Enhance Your Digital Marketing Dissertation? Wondering, How Will We Edit It?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Curious about the editing process for your digital marketing dissertation? Our skilled dissertation specialists operate in focused teams for heightened efficiency. We employ a systematic editorial cycle, with a dedicated team of editors meticulously reviewing your work. This is then looped back to our proofreaders for thorough re-checking. The process repeats until all errors are rectified and your work aligns seamlessly with your specifications."
    }
  },{
    "@type": "Question",
    "name": "Why Choose Our Digital Marketing Dissertation Proofreading Services?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Why opt for our digital marketing dissertation proofreading services? Our seasoned proofreaders, with over 5 years of experience in academia, ensure top-notch quality. Furthermore, our writers are industry experts, well-versed in their respective domains, bringing invaluable insider insights. With a substantial track record of completed dissertations and the satisfaction of over 2300 students across diverse locations, our service stands out."
    }
  },{
    "@type": "Question",
    "name": "Can I communicate with my writer?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! You can easily reach out to our proficient support team via the live chat feature. They will swiftly connect you with your designated writer, allowing you to convey your specific requirements. All communication will smoothly take place within our chat service, ensuring a hassle-free experience for you."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Get expert digital marketing dissertation editing services with certified editors. Ensure 100% originality and excellence. Affordable rates.Get 25% OFF</p>
  ...
  <i class="fa-solid fa-check" id="allcheckicon"></i> <?php echo $freeTopics[2] ?? ''; ?>
        ...
        <div class="d-flex align-items-center justify-content-center" id="formdiv">
              <form class="form" method="POST" id="formentry">
                ...
                <div class="row mb-3">
                    <input type="hidden" method="POST" class="form-control" name="page" value="https://dissertationwritinghelp.net/buy-phd-dissertation-services">
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Steps to Buy a Digital Marketing Dissertation Editing and Proofreading Services</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/Digital-Marketing-Dissertation-Editing-and-Proofreading-Services.webp" alt="Digital Marketing Dissertation Editing and Proofreading Services" title="Digital Marketing Dissertation Editing and Proofreading Services"id="subpagebanner" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/digital-marketing-dissertation-editing-and-proofreading-services-faq.php'?>
