...
$sql = "SELECT * FROM  `asset-management-dissertation-topics-and-ideas-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'asset-management-dissertation-topics-and-ideas';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `asset-management-dissertation-topics-and-i-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How long is a PhD dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The length of a dissertation varies based on factors like its nature, type, and academic level. For instance, a BBA dissertation is typically shorter than an MBA dissertation. Moreover, a PhD dissertation tends to be longer than an MBA one. However, the specific word count for your PhD dissertation may vary based on your supervisor's instructions. Generally, it should not exceed 80,000 words."
    }
  },{
    "@type": "Question",
    "name": "What are tips for completing a dissertation quickly?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Successfully finishing a dissertation quickly requires strong motivation, fast typing skills, and precise grammar. With a few weeks or months at your disposal, creating a well-structured schedule is essential. Ensure it includes adequate breaks to balance your work hours. Maintaining consistency is key to completing your dissertation promptly."
    }
  },{
    "@type": "Question",
    "name": "Is writing an MBA dissertation challenging?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Writing a dissertation can indeed be considered a synonym for difficulty. It demands meticulous attention to various aspects, including grammar and spelling checks, as well as ensuring the absence of plagiarism. If you find dissertation writing challenging, feel free to reach out to our elite team of dissertation experts for assistance."
    }
  },{
    "@type": "Question",
    "name": "Can you assist with dissertation formatting?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We provide comprehensive dissertation solutions. Whether you need a new dissertation crafted from scratch or require assistance with formatting your existing dissertation to your preferred style, we've got you covered. You can contact us via live chat, email, WhatsApp, or phone anytime you need assistance."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/asset-management-dissertation-topics-and-ideas.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Struggling to find Asset Management dissertation topics? Get free, exciting ideas to ace your dissertation. Plus, tips for quick completion and more.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Asset Management Dissertation Topics</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/asset-management-dissertation-topics-and-ideas-faq.php'?>
