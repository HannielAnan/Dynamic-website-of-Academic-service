...
$sql = "SELECT * FROM  `nursing-dissertation-topics-critical-care-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'nursing-dissertation-topics-critical-care';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `nursing-dissertation-topics-critical-care-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How to Make Payment for a Dissertation on DissertationWritingHelp?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Paying for your dissertation has never been easier. We've simplified the process, unlike other services. You can choose from globally recognized payment options like PayPal, Paynote, Debit Cards, Credit Cards, and more. Have questions? Feel free to reach out to us via live chat, where our team is ready to assist and answer all your payment-related queries."
    }
  },{
    "@type": "Question",
    "name": "Can I Place an Order Just 2 Days Before the Deadline?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! If you're in a time crunch, you can still place an order and provide all the critical details to receive your work promptly. Our professional dissertation writers are skilled at producing exceptional dissertations quickly, tailored to your requirements. However, it's advisable to place your order as early as possible so you have time to review and revise your dissertation at your own pace if needed."
    }
  },{
    "@type": "Question",
    "name": "How Can I Track the Progress of My Critical Care Nursing Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Tracking your order is a breeze. Simply utilize our live chat feature on the website. Share your order code with our consultant through live chat, and you'll receive immediate updates and details about your order."
    }
  },{
    "@type": "Question",
    "name": "Choosing the Best Critical Care Nursing Dissertation Topic?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Selecting the right dissertation topic requires careful consideration. You should think through various aspects before diving into your research. Keep in mind any guidelines and instructions provided by your professor or department head. Consider both their interests and your own while making your choice. If you're struggling to find a trending dissertation topic, don't hesitate to reach out to us. We offer suitable critical care nursing research topics, and our services are available round the clock to assist you with any challenges you encounter."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/nursing-dissertation-topics-critical-care.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
   ...
   <p class="hidden">Struggling to find nursing dissertation in critical care? Explore a carefully curated list, designed by experts, to make your dissertation journey easier.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Nursing Dissertation Topics Critical Care</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/nursing-dissertation-topics-critical-care-faq.php'?>
