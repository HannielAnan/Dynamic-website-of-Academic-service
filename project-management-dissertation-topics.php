...
$sql = "SELECT * FROM  `project-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'project-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `project-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Could I receive a failing grade for my MBA Project Management dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "While it is possible to receive a failing grade for your MBA dissertation, you typically have the opportunity to make the necessary revisions and resubmit it. It's crucial to avoid common errors, such as plagiarism and grammatical mistakes, which can lead to immediate rejection."
    }
  },{
    "@type": "Question",
    "name": "What are the recommended referencing styles for a Project Management dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Referencing styles can vary between universities, colleges, and even individual students. Professors or supervisors typically specify the preferred referencing style, so it's advisable to seek their guidance. However, some commonly used referencing styles include APA, MLA, Turabian, Chicago, and Harvard, so you may need to use one of these styles for your references."
    }
  },{
    "@type": "Question",
    "name": "How many chapters should a BBA Project Management dissertation have?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "A BBA Project Management dissertation typically consists of five chapters, each carefully structured to meet specific requirements. These chapters are organized chronologically as follows: Introduction, Literature Review, Methodology, Data Collection & Analysis, and Interpretations + Recommendations."
    }
  },{
    "@type": "Question",
    "name": "Is it secure to purchase a Project Management dissertation online?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Yes, it is entirely safe and legally acceptable to buy a dissertation online. Think of it as seeking professional assistance, similar to consulting guides or friends. You can confidently place an order whenever you need help with your dissertation."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/project-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Project Management dissertation topics and ideas to impress your readers. By field experts, explore BBA and MBA dissertation topics in Project Management.!</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Project Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/project-management-dissertation-topics-faq.php'?>
