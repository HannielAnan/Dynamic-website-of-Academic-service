...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `phd-qualitative-data-analysis-services-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `phd-qualitative-data-analysis-services-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `phd-qualitative-data-analysis-services-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `phd-qualitative-data-analysis-services-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'phd-qualitative-data-analysis-services';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `phd-qualitative-data-analysis-services-title_and-description` WHERE page_identifier = '$pageIdentifier'";
     ...
     <script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "Are urgent dissertation orders accommodated?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely! We acknowledge the significance of meeting deadlines for dissertations and gladly accept urgent orders. It's important to note that urgent orders may entail a slightly adjusted payment"
    }
  },{
    "@type": "Question",
    "name": "Can you assist me in crafting my marketing dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Certainly! We are more than willing to help you compose your marketing dissertation, complete with an innovative title and authentic content."
    }
  },{
    "@type": "Question",
    "name": "Is completing a doctoral dissertation difficult?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Obtaining a doctorate degree involves a highly challenging and intricate dissertation process. However, with the expertise of our experienced PhD writers specializing in doctoral dissertations, no task is insurmountable."
    }
  },{
    "@type": "Question",
    "name": "Where do I need to proceed to initiate my order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Navigate to the top of our website and locate the 'Order Now' tab. Clicking on this tab will lead you through the process of filling out the order form and providing additional details."
    }
  },{
    "@type": "Question",
    "name": "",
...
<!-- End Google Tag Manager (noscript) -->
    <p class="hidden">Unlock Profound Insights with PhD Qualitative Data Analysis. Expert interpretation reveals meaningful patterns for your research success.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simple Process to Buy PhD Qualitative Data Analysis Dissertation Service</h2>
    </div>
  </div>
</div>
<div class="container">
 ...
 <div class="container">
    <div class="row justify-content-center align-items-center">
        <div class="col-lg-12 text-center">
             <img src="images/data-analysis.webp" id="subpagebanner" alt="phd-qualitative-data-analysis-services" class="img-fluid">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/dissertation-writing-service-faq.php'?>
