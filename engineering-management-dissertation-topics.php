...
$sql = "SELECT * FROM  `engineering-management-dissertation-topics-after-brown-box` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
...
$pageIdentifier = 'engineering-management-dissertation-topics';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `engineering-management-dissertation-topics-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    "@type": "Question",
    "name": "How many pages does an MBA dissertation typically have?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Usually, an MBA dissertation falls within the range of 40 to 80 pages. However, it's important to confirm the specific word count limits with your supervisor or professor. The length of your dissertation may vary based on its nature, topic, and type. If you encounter challenges while writing your dissertation, don't hesitate to reach out to us for expertly crafted dissertations in a timely manner."
    }
  },{
    "@type": "Question",
    "name": "Does my choice of dissertation topic impact my resume?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely, your choice of dissertation topics significantly influences your resume because all your dissertation topics are showcased on it. Every potential employer will scrutinize your dissertation topic, making it crucial to have captivating topics that leave a positive first impression. Carelessly selecting a mediocre dissertation topic can create a negative impression on employers and readers alike."
    }
  },{
    "@type": "Question",
    "name": "What is the weight of each chapter in a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Balancing the chapters in your dissertation is essential. Chapter weights are determined by the word count of each chapter. Typically, the recommended chapter weights are as follows: the introduction chapter carries 15%, the literature review chapter holds 30%, the methodology chapter accounts for 10%, while the data collection and analysis chapter comprises 30%, and the interpretation and recommendation chapter carries 15%."
    }
  },{
    "@type": "Question",
    "name": "Is it legal to purchase a dissertation online?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Purchasing a dissertation online is just as legal and legitimate as seeking guidance from textbooks and academic resources. You can rest assured that there are no legal issues associated with ordering a dissertation online. Our qualified team of professionals is available 24/7 to meet all your dissertation needs. Feel free to place an order now and enjoy high-quality dissertation services at competitive prices."
    }
  },{
    "@type": "Question",
    "name": "",
...
#colorp{
   ...
   /* Custom CSS for the container */
        .custom-container {
            position: relative;
            background-image: url('images/engineering-management-dissertation-topics.webp'); /* Replace with your image URL */
            background-size: cover;
...
<body>
    ...
    <p class="hidden">Engineering Management dissertation topics with our open-ended ideas. Tailor topics to your interests and meet your supervisor's requirements.</p>
  <?php include 'includes/navbar.php'?>
   <div class="container custom-container">
        <div class="row">
            <div class="col" id="col1">
                <h1 class="custom-heading">Engineering Management Dissertation Topics and Ideas</h1>
            </div>
        </div>
    </div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/engineering-management-dissertation-topics-faq.php'?>
