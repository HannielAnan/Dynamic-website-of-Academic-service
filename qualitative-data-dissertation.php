...
$sql = "SELECT `heading`, `point1`, `point2`, `point3` FROM  `qualitative-data-dissertation-black-box`";
...
// Fetch the data from the table
$sql = "SELECT * FROM `qualitative-data-dissertation-3brown-boxes`";
$result = $conn->query($sql);
...
//after brown boxes 
// Fetch the data from the table
$sql = "SELECT * FROM `qualitative-data-dissertation-2headings` WHERE id = 1";
$result = $conn->query($sql);
...
//Big brown box 
//Fetch the data from the table
$sql = "SELECT * FROM `qualitative-data-dissertation-big-brown-box` WHERE id = 0";
$result = $conn->query($sql);
...
// // Fetch the data from the table
$sql = "SELECT * FROM  `qualitative-data-dissertation-after-brown-box3` WHERE id = 1"; // Replace 'your_table_name' with the actual table name
$result = $conn->query($sql);
...
$pageIdentifier = 'qualitative-data-dissertation';
$title = ''; // Initialize an empty variable for title
$metaDescription = ''; // Initialize an empty variable for meta description

// Construct the query
$query = "SELECT title, meta_description FROM `qualitative-data-dissertation-title_and-description` WHERE page_identifier = '$pageIdentifier'";
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [{
    ...
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "Absolutely not! We are transparent about our pricing, and there are no hidden charges. All our prices and fees are openly stated."
    }
  },{
    "@type": "Question",
    "name": "How do I proceed with placing an order?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "To initiate your order, simply click on the 'order now' tab located at the top of the page. This will lead you to our online order form."
    }
  },{
    "@type": "Question",
    "name": "What is the expected delivery time for my dissertation order?",
    "acceptedAnswer": {
      "@type": "Answer",
    ...
    "@type": "Question",
    "name": "What is the typical duration for completing a dissertation?",
    "acceptedAnswer": {
      "@type": "Answer",
      "text": "The time needed to write a dissertation varies based on its requirements. Generally, it takes around one to two months, although our experts can also manage shorter deadlines."
    }
  },{
    "@type": "Question",
    "name": "",
...
<body>
    ...
    <p class="hidden">Explore 'Qualitative Data Dissertation': Unveiling insights through expert analysis, enriching your study's depth and reflection.</p>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-lg-12">
      <h2 id="heading3rd">Simplified Procedure to Buy Qualitative Data Dissertations</h2>
    </div>
  </div>
</div>
<div class="container">
...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <img src="images/Qualitative-Data-Dissertation-Services.webp" id="subpagebanner" class="img-fluid" alt="qualitative data dissertation">
        </div>
    </div>
</div>
  ...
  <div class="row" style="background-color: #f5f6f7;padding:30px;">
    ...
    <!--After brownbox container end--!-->
          <!--FAQ container start--!-->
              ...
              <?php include 'includes/qualitative-data-dissertation-service-faq.php'?>
